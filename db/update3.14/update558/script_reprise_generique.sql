...
FROM(
select mvt.date_valeur,cpte.id_cpte,cpte.id_titulaire,cpte.etat_cpte,cpte.solde,his.id_ag, (select id_his from ad_his where type_fonction = 501) as id_his,'admin'::text as login,501 as type_fonction 
