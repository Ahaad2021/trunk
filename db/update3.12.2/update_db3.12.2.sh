...
execute_psql 0 updata3.12.2.sql

# Mise-a-jour #413 fonction base_ getportfeuilleview 
execute_psql 0 fix_getportefeuilleview.sql

# Mise-a-jour #504 fonction base_ getgrandlivreview
execute_psql 0 fix_getgrandlivreview.sql
