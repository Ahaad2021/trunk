...
if [[ "$TEST" >0 ]]; then
    ...
    execute_psql 0 /usr/share/adbanking/db/update3.22/update3.22.0-beta2/updata3.22.0-beta2.sql
    #execute_psql 0 /usr/share/adbanking/db/update3.20.2.1/update3.20.2.1-RC1/arrete_comptes.sql

else
    source /usr/share/adbanking/db/update3.22/update3.22.0-beta2/update_db3.22.0-beta2.sh $1
fi