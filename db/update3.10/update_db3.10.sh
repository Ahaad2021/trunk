...
# NOTE : IL FAUT MODIFIER CETTE PROCHAINE ETAPE EN INTEGRANT LES CODES SQL DANS NEW_DB ETC ticket#338

# Mise à jour structure
execute_psql 0 updata3.10.sql
# Mise à jour structure pour le ticket #357
execute_psql 0 patch_ticket_357.sql
# Mise à jour structure pour le ticket #387
execute_psql 0 patch_ticket_387.sql
# Mise à jour structure pour le ticket #430
execute_psql 0 patch_ticket_430.sql
