                    ...
                    <fo:table-header>
                        <fo:table-row font-weight="bold" font-size="9pt" border="0.1pt solid gray">
                            <fo:table-cell border="0.1pt solid gray">
                                <fo:block text-align="center">Date de Révision</fo:block>
                            </fo:table-cell>
                            <fo:table-cell border="0.1pt solid gray">
                                <fo:block text-align="center">Ligne Budgetaire</fo:block>
                            </fo:table-cell>
                            <fo:table-cell border="0.1pt solid gray">
                                <fo:block text-align="center">Login qui a révisé le budget</fo:block>
                            </fo:table-cell>
                            <fo:table-cell border="0.1pt solid gray">
                                <fo:block text-align="center">Login qui a validé la révision budgétaire</fo:block>
                            </fo:table-cell>
                            <fo:table-cell border="0.1pt solid gray">
                                <fo:block text-align="center">Ancien montant budgétisé</fo:block>
                            </fo:table-cell>
                            <fo:table-cell border="0.1pt solid gray">
                                <fo:block text-align="center">Nouveau montant budgétisé</fo:block>
                            </fo:table-cell>
                            <fo:table-cell border="0.1pt solid gray">
