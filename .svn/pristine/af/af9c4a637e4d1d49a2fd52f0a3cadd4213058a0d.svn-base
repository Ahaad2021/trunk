  ...
  <xsl:template match="body">
    <fo:list-block>
      ...
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.3cm">Produit d'épargne : <xsl:value-of select="libelprod"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.3cm">Solde : <xsl:value-of select="solde"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
