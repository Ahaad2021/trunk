		...
		<xsl:for-each select="situation_agence">
			...
			<fo:table border-collapse="collapse" width="100%" table-layout="fixed">
				...
				<fo:table-body>
					...
					<!-- commission OD en deplacee -->
					<fo:table-row>
						<fo:table-cell display-align="center" border="0.1pt solid gray">
							<fo:block text-align="left">
								Commission sur operation en deplace
							</fo:block>
						</fo:table-cell>

						<fo:table-cell display-align="center" border="0.1pt solid gray">
							<fo:block text-align="right">
								<xsl:value-of select="situation_local/donnees_agence/comm_od_deplace" />
							</fo:block>
						</fo:table-cell>
						...
						<fo:table-cell display-align="center" border="0.1pt solid gray">
							<fo:block text-align="right">
								<xsl:value-of select="situation_distant/donnees_agence/comm_od_deplace" />
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
