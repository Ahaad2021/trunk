  ...
  <xsl:template match="body">
    <fo:list-block>
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.2cm">Date opération: <xsl:value-of select="date_op"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.2cm">Libellé opération: <xsl:value-of select="libelle_op"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
    </fo:list-block>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:list-block>
              ...
              <fo:list-item>
                ...
                <fo:list-item-body>
                  <fo:block space-before.optimum="0.2cm">Montant débit: <xsl:value-of select="montant_debit"/></fo:block>
                </fo:list-item-body>
              </fo:list-item>
              <fo:list-item>
                <fo:list-item-label>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:list-block>
              ...
              <fo:list-item>
                ...
                <fo:list-item-body>
                  <fo:block space-before.optimum="0.2cm">Montant crédit: <xsl:value-of select="montant_credit"/></fo:block>
                </fo:list-item-body>
              </fo:list-item>
              <fo:list-item>
                <fo:list-item-label>
    ...
    <fo:list-block>
      ...
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.2cm">Date pièce: <xsl:value-of select="date_piece"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.2cm">Communication: <xsl:value-of select="communication"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.2cm">Remarque: <xsl:value-of select="remarque"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.2cm">Numéro de transaction: <xsl:value-of select="num_trans"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
    </fo:list-block>
    <fo:block space-before.optimum="1cm"/>
