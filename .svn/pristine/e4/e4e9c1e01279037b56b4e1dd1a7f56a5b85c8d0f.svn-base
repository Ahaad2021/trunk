    ...
    <fo:table>
      ...
      <fo:table-body>
        ...
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="encours_clients_deb"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
        ...
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="encours_retard_deb"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="ratio_retard"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="total_sain"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-body>
    ...
    <fo:table border-collapse="separate" width="100%" table-layout="fixed">
      ...
      <fo:table-header>
        <fo:table-row font-weight="bold">
          ...
          <fo:table-cell>
            <fo:block text-align="right">C/V credits outstanding</fo:block>
          </fo:table-cell>
          <fo:table-cell>
