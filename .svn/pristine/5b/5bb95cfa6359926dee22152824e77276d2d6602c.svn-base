          ...
          <fo:table-header>
            <fo:table-row font-weight="bold">
              <fo:table-cell number-columns-spanned="5">
                <fo:block text-align="center">ASSETS</fo:block>
              </fo:table-cell>
              <fo:table-cell number-columns-spanned="3">
                <fo:block text-align="center">LIABILITY</fo:block>
              </fo:table-cell>
            </fo:table-row>
            <fo:table-row font-weight="bold">
              ...
              <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black" border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
                <fo:block text-align="left">Account designation</fo:block>
              </fo:table-cell>
              <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black" border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
                <fo:block text-align="center">Gross</fo:block>
              </fo:table-cell>
              <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black" border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
                <fo:block text-align="center">AmtProv</fo:block>
              </fo:table-cell>
              <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black" border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
                <fo:block text-align="center">Net Bank payment</fo:block>
              </fo:table-cell>
              <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black" border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
                <fo:block text-align="left">No.</fo:block>
              </fo:table-cell>
      ...
      <fo:table-row font-weight="bold">
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black" border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
          <fo:block text-align="left">
            <xsl:value-of select="compte_actif"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black" border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
          <fo:block text-align="left">
            <xsl:value-of select="libel_actif"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black" border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
          <fo:block text-align="right">
            <xsl:value-of select="solde_actif"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black" border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
          <fo:block text-align="right">
            <xsl:value-of select="amort_actif"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black" border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
          <fo:block text-align="right">
            <xsl:value-of select="net_actif"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black" border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
          <fo:block text-align="left">
            <xsl:value-of select="compte_passif"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black" border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
          <fo:block text-align="left">
            <xsl:value-of select="libel_passif"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black" border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
          <fo:block text-align="right">
            <xsl:value-of select="solde_passif"/>
          </fo:block>
        </fo:table-cell>
      </fo:table-row>
    </xsl:if>
    <xsl:if test="@total = '0'">
      <fo:table-row>
        <xsl:choose>
          ...
          <xsl:otherwise>
            <fo:table-cell>
              <fo:block text-align="right" space-before.optimum="0.2cm" font-style="italic">
                <xsl:value-of select="compte_actif"/>
              </fo:block>
            </fo:table-cell>
            <fo:table-cell>
              <fo:block text-align="left" space-before.optimum="0.2cm" font-style="italic">
                <xsl:value-of select="libel_actif"/>
              </fo:block>
            </fo:table-cell>
            <fo:table-cell>
