        ...
        <fo:list-block>
            ...
            <xsl:if test="nom_operateur">
                <fo:list-item>
                    ...
                    <fo:list-item-body>
                        <fo:block space-before.optimum="0.3cm">Teller name : <xsl:value-of select="nom_operateur"/></fo:block>
                    </fo:list-item-body>
                </fo:list-item>
            </xsl:if>
            <xsl:if test="login">
            ...
            <xsl:if test="type_action='1'">
                ...
                <fo:list-item>
                    ...
                    <fo:list-item-body>
                        <fo:block space-before.optimum="0.3cm">Cash in vault account credited  : <xsl:for-each select="../compte_debit"> <xsl:value-of select="compte_coffre_debit"/>.  </xsl:for-each></fo:block>
                    </fo:list-item-body>
                </fo:list-item>
                <!--</xsl:if>-->
                <xsl:if test="compte_caisse_credit">
                    <fo:list-item>
                        ...
                        <fo:list-item-body>
                            <fo:block space-before.optimum="0.3cm">Cash in hand account debited  : <xsl:value-of select="compte_caisse_credit"/></fo:block>
                        </fo:list-item-body>
                    </fo:list-item>
                </xsl:if>
            </xsl:if>
            <xsl:if test="type_action='2'">
                ...
                <fo:list-item>
                    ...
                    <fo:list-item-body>
                        <fo:block space-before.optimum="0.3cm">Cash in vault account debited  : <xsl:for-each select="../compte_debit"> <xsl:value-of select="compte_coffre_debit"/>.  </xsl:for-each></fo:block>
                    </fo:list-item-body>
                </fo:list-item>
                <!--</xsl:if>-->
                <xsl:if test="compte_caisse_credit">
                    <fo:list-item>
                        ...
                        <fo:list-item-body>
                            <fo:block space-before.optimum="0.3cm">Cash in hand account credited  : <xsl:value-of select="compte_caisse_credit"/></fo:block>
                        </fo:list-item-body>
                    </fo:list-item>
                </xsl:if>
            </xsl:if>
            <xsl:if test="type_recu='1'">
                <xsl:if test="../transaction">
                    <fo:list-item>
                        ...
                        <fo:list-item-body>
                            <fo:block space-before.optimum="0.3cm">Request number : <xsl:for-each select="../transaction"> [<xsl:value-of select="num_transaction"/>] </xsl:for-each></fo:block>
                        </fo:list-item-body>
                    </fo:list-item>
                </xsl:if>
            </xsl:if>
            <xsl:if test="type_recu='2'">
                <xsl:if test="../transaction">
                    <fo:list-item>
                        ...
                        <fo:list-item-body>
                            <fo:block space-before.optimum="0.3cm">Transaction number :  <xsl:for-each select="../transaction"> <xsl:value-of select="num_transaction"/> </xsl:for-each></fo:block>
                        </fo:list-item-body>
                    </fo:list-item>
                </xsl:if>
            </xsl:if>
            <xsl:if test="type_action='1'">
                ...
                <fo:list-item>
                    ...
                    <fo:list-item-body>
                        <fo:block space-before.optimum="0.3cm">Amount supplied :<xsl:for-each select="../montant_appro_delestage">  <xsl:value-of select="montant"/>.  </xsl:for-each></fo:block>
                    </fo:list-item-body>
                </fo:list-item>
                <!--</xsl:if>-->
            </xsl:if>
            <xsl:if test="type_action='2'">
                ...
                <fo:list-item>
                    ...
                    <fo:list-item-body>
                        <fo:block space-before.optimum="0.3cm">Amount relieved :<xsl:for-each select="../montant_appro_delestage">  <xsl:value-of select="montant"/>.  </xsl:for-each></fo:block>
                    </fo:list-item-body>
                </fo:list-item>
                <!--</xsl:if>-->
            </xsl:if>
        ...
        <xsl:for-each select="../temp_devise">
            <xsl:if test="hasBilletage">
                <fo:list-item>
                    ...
                    <fo:list-item-body><fo:block space-before.optimum="0.3cm">Billeting : <xsl:value-of select="devise" /> </fo:block></fo:list-item-body>
                </fo:list-item>
            ...
            <fo:table-body>
                <fo:table-row>
                    ...
                    <fo:table-cell border-width="0.5pt" border-color="grey" border-style="solid" padding="6pt">
                        <fo:block text-align="left">Banknotes and coins</fo:block>
                    </fo:table-cell>
