		...
		<fo:table border-collapse="separate" border-separation.inline-progression-direction="10pt" width="35%" table-layout="fixed">
			...
			<fo:table-header>
				<fo:table-row font-weight="bold">
					<fo:table-cell>
						<fo:block text-align="left">État chéquier</fo:block>
					</fo:table-cell>
					<fo:table-cell>
		...
		<fo:table border-collapse="collapse" width="100%" table-layout="fixed">
			...
			<fo:table-header>
				...
				<fo:table-row font-weight="bold">
					...
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">Date de livraison</fo:block>
					</fo:table-cell>
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">Etat du chéquier</fo:block>
					</fo:table-cell>
					<fo:table-cell display-align="center" border="0.1pt solid gray">
					...
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">Nombre de chèques</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-header>
			...
			<fo:table-body>
				<xsl:for-each select="ligne_chequier">
					<fo:table-row>
						...
						<fo:table-cell display-align="center" border="0.1pt solid gray">
							<fo:block text-align="left"><xsl:value-of select="nb_cheq" /></fo:block>
						</fo:table-cell>
					</fo:table-row>
				</xsl:for-each>
			</fo:table-body>
