...
<xsl:template match="body">
	<fo:list-block>
		...
		<fo:list-item>
			<fo:list-item-label><fo:block></fo:block></fo:list-item-label>
			<fo:list-item-body><fo:block space-before.optimum="0.3cm">Date d'adhésion: <xsl:value-of select="date_adhesion"/></fo:block></fo:list-item-body>
		</fo:list-item>
		<fo:list-item>
			<fo:list-item-label><fo:block></fo:block></fo:list-item-label>
			<fo:list-item-body><fo:block space-before.optimum="0.3cm">Date de défection: <xsl:value-of select="date_defection"/></fo:block></fo:list-item-body>
		</fo:list-item>
		<fo:list-item>
			<fo:list-item-label><fo:block></fo:block></fo:list-item-label>
			<fo:list-item-body><fo:block space-before.optimum="0.3cm">Motif de la défection: <xsl:value-of select="motif_defection"/></fo:block></fo:list-item-body>
		</fo:list-item>
		<fo:list-item>
			<xsl:if test="balance_debit">
				<fo:list-item-label><fo:block></fo:block></fo:list-item-label>
				<fo:list-item-body><fo:block space-before.optimum="0.3cm">Recu du client la somme de: <xsl:value-of select="balance_debit"/></fo:block></fo:list-item-body>
			</xsl:if>
			<xsl:if test="balance_credit">
				<fo:list-item-label><fo:block></fo:block></fo:list-item-label>
				<fo:list-item-body><fo:block space-before.optimum="0.3cm">Remis au client la somme de: <xsl:value-of select="balance_credit"/></fo:block></fo:list-item-body>
			</xsl:if>
		</fo:list-item>
		<fo:list-item> 
 	    <fo:list-item-label><fo:block></fo:block></fo:list-item-label> 
 	      <fo:list-item-body><fo:block space-before.optimum="0.3cm">Ayant droit présent: <xsl:value-of select="nom_ayant_droit"/></fo:block></fo:list-item-body> 
 	  </fo:list-item>
		<fo:list-item>
			<fo:list-item-label><fo:block></fo:block></fo:list-item-label>
