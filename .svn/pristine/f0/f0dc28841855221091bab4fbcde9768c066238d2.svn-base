...
if ($global_nom_ecran == "Atd-1") {

  global $global_id_client;

  $my_page = new HTML_GEN2("Liste de demandes d'autorisation de retrait en déplacé");
  ...
  // Header row
  $my_page->addField("checkall_valid","<span style='width: 40px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-bottom-width: 1px;border-right-width: 1px;border-bottom-style: solid;border-right-style: solid;border-bottom-color: #007777;border-right-color: #007777;font-weight: bold;'>N°</span><span style='width: 80px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-bottom-width: 1px;border-right-width: 1px;border-bottom-style: solid;border-right-style: solid;border-bottom-color: #007777;border-right-color: #007777;font-weight: bold;'>N° Client</span><span style='width: 250px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-bottom-width: 1px;border-right-width: 1px;border-bottom-style: solid;border-right-style: solid;border-bottom-color: #007777;border-right-color: #007777;font-weight: bold;'>Type de transfert</span><span style='width: 130px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-bottom-width: 1px;border-right-width: 1px;border-bottom-style: solid;border-right-style: solid;border-bottom-color: #007777;border-right-color: #007777;font-weight: bold;'>Montant</span><span style='width: 130px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-bottom-width: 1px;border-right-width: 1px;border-bottom-style: solid;border-right-style: solid;border-bottom-color: #007777;border-right-color: #007777;font-weight: bold;'>Date demande</span><span style='width: 90px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-bottom-width: 1px;border-right-width: 1px;border-bottom-style: solid;border-right-style: solid;border-bottom-color: #007777;border-right-color: #007777;font-weight: bold;'>Utilisateur</span>", TYPC_BOL);
  ...
  $listeDemandeRetraitDeplace= getListeRetraitDeplaceAttente();

  $displayHeader = true;
  foreach ($listeDemandeRetraitDeplace as $id => $demandeRetraitDeplace) {

    $id_demande = trim($demandeRetraitDeplace["id"]);
    $id_client = $demandeRetraitDeplace["id_client_distant"];
    $choix_retrait_deplace = getLabelChoixRetraitDeplace($demandeRetraitDeplace["type_retrait"]);
    $montant_retrait_deplace = afficheMontant($demandeRetraitDeplace["montant_retrait"], true);
    $date_demande = pg2phpDate($demandeRetraitDeplace["date_creation"]);
    $login = $demandeRetraitDeplace["login"];
    ...
    $libelle_demande = sprintf("<span style='width: 40px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-right-width: 1px;border-right-style: solid;border-right-color: #007777;'>%s</span><span style='width: 80px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-right-width: 1px;border-right-style: solid;border-right-color: #007777;'>%s</span><span style='width: 250px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-right-width: 1px;border-right-style: solid;border-right-color: #007777;'>%s</span><span style='width: 130px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-right-width: 1px;border-right-style: solid;border-right-color: #007777;'>%s</span><span style='width: 130px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-right-width: 1px;border-right-style: solid;border-right-color: #007777;'>%s</span><span style='width: 90px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-right-width: 1px;border-right-style: solid;border-right-color: #007777;'>%s</span>", $id_demande,$id_client, $choix_retrait_deplace, $montant_retrait_deplace, $date_demande,$login);
  ...
  $my_page->setFormButtonProperties("btn_process_demande", BUTP_PROCHAIN_ECRAN, 'Atd-2');
...
} elseif ($global_nom_ecran == "Atd-2") {
  

  global $global_id_client;
  $erreur = processAutorisationRetraitDeplaceAttente($_POST, $global_id_client);
