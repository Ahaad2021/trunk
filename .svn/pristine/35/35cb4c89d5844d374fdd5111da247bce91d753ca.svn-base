...
<xsl:call-template name="titre_niv1"><xsl:with-param name="titre" select="liblocal"/></xsl:call-template>
	...
	<fo:table-header>
		<fo:table-row>
			<fo:table-cell display-align="center" border="0.1pt solid gray">
					<fo:block font-weight="bold" text-align="center">Libelle</fo:block>
			</fo:table-cell>
			<xsl:for-each select="libcolonne">
				<fo:table-cell display-align="center" border="0.1pt solid gray">
...
<xsl:template match="ligne">
		<fo:table-row>
			<fo:table-cell display-align="center" border="0.1pt solid gray">
				<fo:block text-align="center"><xsl:value-of select="libligne"/></fo:block>
			</fo:table-cell>
...
<xsl:template match="monocritere">
	<fo:table width="100%" table-layout="fixed">
		...
		<fo:table-body>
			<fo:table-row>
				<fo:table-cell display-align="center" border="0.1pt solid gray">
					<fo:block text-align="center"><xsl:value-of select="libelle"/></fo:block>
				</fo:table-cell>
				<fo:table-cell display-align="center" border="0.1pt solid gray">
					<fo:block text-align="center"><xsl:value-of select="nbre"/></fo:block>
				</fo:table-cell>
			</fo:table-row>
		</fo:table-body>
	</fo:table>
