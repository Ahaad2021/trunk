...
<xsl:template match="ligne">
	<fo:table-row>
		...
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block text-align="right"><xsl:value-of select="solde_contre_valeur"/></fo:block>
		</fo:table-cell>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block text-align="center"><xsl:value-of select="date_echeance"/></fo:block>
		</fo:table-cell>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block text-align="center"><xsl:value-of select="taux_interet"/></fo:block>
		</fo:table-cell>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block text-align="center"><xsl:value-of select="proroge"/></fo:block>
		</fo:table-cell>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block text-align="center"><xsl:value-of select="decision"/></fo:block>
		</fo:table-cell>
	</fo:table-row>	
</xsl:template>
...
<xsl:template match="sous_total">
	<fo:table-row font-weight="bold" font-style="italic" border-collapse="separate" border-separation.block-progression-direction="25pt">
		...
		<fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="2" >
			<fo:block text-align="center"><xsl:value-of select="montant_total"/></fo:block>
		</fo:table-cell>
	</fo:table-row>	
</xsl:template>
...
<xsl:template match="total_general">
	<fo:table-body>
		<fo:table-row font-weight="bold" font-style="italic" border-collapse="separate" border-separation.block-progression-direction="25pt">
			...
			<fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="2">
				<fo:block text-align="center"><xsl:value-of select="total_montant"/></fo:block>
			</fo:table-cell>
		</fo:table-row>	
	</fo:table-body>
</xsl:template>
