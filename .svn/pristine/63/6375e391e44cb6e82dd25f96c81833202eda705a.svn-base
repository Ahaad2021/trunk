  ...
  <xsl:template match="body">
    <fo:table>
      ...
      <fo:table-body>
        ...
        <fo:table-row>
          <fo:table-cell>
            <fo:block font-weight="bold">Source of purchase</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block text-align="right">
    ...
    <fo:table>
      ...
      <fo:table-body>
        <fo:table-row>
          <fo:table-cell font-weight="bold">
            <fo:block>Rate <xsl:value-of select="devise_achat"/><xsl:value-of select="$icone_fleche" disable-output-escaping="yes"/><xsl:value-of select="devise_vente"/> </fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block/>
          </fo:table-cell>
    ...
    <fo:block space-before.optimum="0.3cm">Transaction number: <xsl:value-of select="id_his"/></fo:block>
    
    <xsl:if test="hasBilletage">
   		<fo:list-item>
        	<fo:list-item-label><fo:block></fo:block></fo:list-item-label>
            <fo:list-item-body><fo:block space-before.optimum="0.3cm">Notes : </fo:block></fo:list-item-body>
		</fo:list-item>
