...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
    <xsl:template match="/">
        <fo:root>
            ...
            <xsl:apply-templates select="detail_transaction_engraischimiques"/>
        </fo:root>
    </xsl:template>
    ...
    <xsl:template match="detail_transaction_engraischimiques">
        ...
        <fo:table border-collapse="collapse" width="100%" table-layout="fixed">
            ...
            <fo:table-header>
                <fo:table-row font-weight="bold">
                    ...
                    <fo:table-cell display-align="center" border="0.1pt solid gray">
                        <fo:block text-align="center">N° bénéficiaire</fo:block>
                    </fo:table-cell>
                    <fo:table-cell display-align="center" border="0.1pt solid gray">
    ...
    <xsl:template match="his_data">
        <fo:table-row>
            ...
            <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center">
                    <xsl:value-of select="num_beneficiaire"/>
                </fo:block>
            </fo:table-cell>
            <fo:table-cell display-align="center" border="0.1pt solid gray">
