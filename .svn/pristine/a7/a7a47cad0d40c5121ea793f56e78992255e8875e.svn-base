...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
    ...
    <fo:table border-collapse="separate" border-separation.inline-progression-direction="10pt" width="100%" table-layout="fixed">
      ...
      <fo:table-header>
        <fo:table-row font-weight="bold">
          ...
          <fo:table-cell>
            <fo:block text-align="right">Number of loans</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block text-align="right">Amount</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block text-align="right">Percentage at risk</fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-header>
      <fo:table-body>
  ...
  <xsl:template match="detailsretard">
         <fo:block text-align="left" font-size="14pt" font-weight="bold" border-top-style="solid" border-bottom-style="solid" space-before="0.5in">Credit status :  <xsl:value-of select="lib_detail"/></fo:block>     
    ...
    <fo:table border-collapse="separate" border-separation.inline-progression-direction="10pt" width="100%" table-layout="fixed">
      ...
      <fo:table-header>
        <fo:table-row font-weight="bold">
          <fo:table-cell>
            <fo:block text-align="left">Loan nbr</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block text-align="right">Amount of loan</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block text-align="right">Balance</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block text-align="right">Principal amount</fo:block>
          </fo:table-cell>
          <fo:table-cell>
          ...
          <fo:table-cell>
            <fo:block text-align="right">Unpaid</fo:block>
          </fo:table-cell>
          <fo:table-cell>
  ...
  <xsl:template match="totalprcentage">
    ...
    <fo:list-block>
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block><xsl:value-of select="$point_liste" disable-output-escaping="yes"/>Loan late portefolio : <xsl:value-of select="totalenretard"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
        ...
        <fo:list-item-body>
          <fo:block><xsl:value-of select="$point_liste" disable-output-escaping="yes"/>Total portefolio of current loans : <xsl:value-of select="totalsain"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
      ...
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block><xsl:value-of select="$point_liste" disable-output-escaping="yes"/>Percentage at risk : <xsl:value-of select="pourcentagerisque"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
    </fo:list-block>
  </xsl:template>
  <xsl:template match="dossiersretard">
    ...
    <fo:table-row>
      <fo:table-cell>
        <fo:block font-weight="bold" font-style="italic" wrap-option="no-wrap" text-align="right">Client nbr:</fo:block>
      </fo:table-cell>
      <fo:table-cell>
      ...
      <fo:table-cell>
        <fo:block font-weight="bold" font-style="italic" wrap-option="no-wrap" text-align="right">Client name:</fo:block>
      </fo:table-cell>
      <fo:table-cell>
        <fo:block font-style="italic" wrap-option="no-wrap" text-align="left">
      ...
      <fo:table-cell>
        <fo:block font-weight="bold" font-style="italic" wrap-option="no-wrap" text-align="right">Currency:</fo:block>
      </fo:table-cell>
      <fo:table-cell>
        <fo:block font-style="italic" wrap-option="no-wrap" text-align="left">
      ...
      <fo:table-cell>
        <fo:block font-weight="bold" font-style="italic" wrap-option="no-wrap" text-align="right">Manager:</fo:block>
      </fo:table-cell>
      <fo:table-cell>
        <fo:block font-style="italic" wrap-option="no-wrap" text-align="left">
