...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  ...
  <xsl:template match="details">
    <xsl:call-template name="titre_niv1">
      <xsl:with-param name="titre" select="'Detailed of Risks Situation by Sector'"/>
    </xsl:call-template>
    <fo:table border-collapse="separate" width="100%" table-layout="fixed">
      ...
      <fo:table-header>
        <fo:table-row font-weight="bold">
          <fo:table-cell border-width="0.1mm" border-style="solid" padding-right="2px">
            <fo:block text-align="left">Postal Code</fo:block>
          </fo:table-cell>
          <fo:table-cell border-width="0.1mm" border-style="solid" padding-right="2px">
          ...
          <fo:table-cell border-width="0.1mm" border-style="solid" padding-right="2px">
            <fo:block text-align="left">Nbr of individual debtors</fo:block>
          </fo:table-cell>
          <fo:table-cell border-width="0.1mm" border-style="solid" padding-right="2px">
    ...
    <fo:table-row>
      ...
      <fo:table-cell border-width="0.1mm" border-style="solid" text-align="center">
        <fo:block text-align="left">
          <xsl:value-of select="libel_act"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell border-width="0.1mm" border-style="solid">
        <fo:block text-align="right">
          <xsl:value-of select="mnt_cred"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell border-width="0.1mm" border-style="solid">
        <fo:block text-align="center">
          <xsl:value-of select="nbr_ind_deb"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell border-width="0.1mm" border-style="solid">
        <fo:block text-align="center">
          <xsl:value-of select="nbr_grp_deb"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell border-width="0.1mm" border-style="solid" text-align="center">
        <fo:block text-align="center">
          <xsl:value-of select="nbr_grp_benef_pret"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell background-color="#CCFFFF" border-width="0.1mm" border-style="solid">
        <fo:block text-align="center">
          <xsl:value-of select="nbr_benef_act"/>
        </fo:block>
      </fo:table-cell>
    </fo:table-row>
  </xsl:template>
    ...
    <fo:table-row>
      ...
      <fo:table-cell background-color="#CCFFFF" border-width="0.2mm" border-style="solid" text-align="right">
        <fo:block font-weight="bold" text-align="right">
          <xsl:value-of select="tot_mnt_cred"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell background-color="#CCFFFF" border-width="0.2mm" border-style="solid" text-align="right">
        <fo:block font-weight="bold" text-align="center">
          <xsl:value-of select="tot_ind_deb"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell background-color="#CCFFFF" border-width="0.2mm" border-style="solid" text-align="right">
        <fo:block font-weight="bold" text-align="center">
          <xsl:value-of select="tot_grp_deb"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell background-color="#CCFFFF" border-width="0.2mm" border-style="solid" text-align="right">
        <fo:block font-weight="bold" text-align="center">
          <xsl:value-of select="tot_grp_benef_pret"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell background-color="#CCFFFF" border-width="0.2mm" border-style="solid" text-align="right">
        <fo:block font-weight="bold" text-align="center">
          <xsl:value-of select="tot__benef_pret"/>
        </fo:block>
      </fo:table-cell>
    </fo:table-row>
  </xsl:template>
