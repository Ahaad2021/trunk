...
<xsl:template match="/">
	<fo:root>
		<xsl:call-template name="page_layout_A5_portrait_no_region"></xsl:call-template>
...
<xsl:template match="beneficaires">
	<fo:table-row>
		<fo:table-cell  border="0.1pt solid gray" >
			<fo:block><xsl:value-of select="nomBeneficaire"/></fo:block>
		</fo:table-cell>
		<fo:table-cell  border="0.1pt solid gray" >
			<fo:block><xsl:value-of select="numCpteBeneficaire"/></fo:block>
		</fo:table-cell>
		<fo:table-cell  border="0.1pt solid gray">
			<fo:block><xsl:value-of select="dateDemandeVir"/></fo:block>
		</fo:table-cell>
		<fo:table-cell  border="0.1pt solid gray">
			<fo:block text-align="right"><xsl:value-of select="mntPreleve"/></fo:block>
		</fo:table-cell>
		<fo:table-cell  border="0.1pt solid gray">
			<fo:block text-align="right"><xsl:value-of select="mntBeneficaire"/></fo:block>
		</fo:table-cell>
		<xsl:if test="/recu/body/beneficaires/frais !=''">
				       <fo:table-cell  border="0.1pt solid gray">
							   <fo:block text-align="center"><xsl:value-of select="frais"/> </fo:block>
						   </fo:table-cell>
				   </xsl:if>
