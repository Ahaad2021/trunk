  ...
  <xsl:template match="body">
    <fo:list-block>
      ...
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.3cm">Montant de la tranche versé: <xsl:value-of select="montant_versement"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.3cm">Montant total frais d'adhésion versé : <xsl:value-of select="montant_frais_adh_verse"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.3cm">Montant des frais d'adhésion restant: <xsl:value-of select="montant_frais_adh_restant"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
