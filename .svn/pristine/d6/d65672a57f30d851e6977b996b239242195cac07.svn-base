          ...
          <fo:table-header>
            <fo:table-row font-weight="bold">
              <fo:table-cell number-columns-spanned="3">
                <fo:block text-align="center">Operating fees</fo:block>
              </fo:table-cell>
              <fo:table-cell number-columns-spanned="3">
                <fo:block text-align="center">PRODUCTS</fo:block>
              </fo:table-cell>
            </fo:table-row>
            <fo:table-row font-weight="bold">
      ...
      <fo:table-row font-weight="bold">
        <fo:table-cell border-top-width="0.3pt" border-top-style="solid" border-top-color="gray" border-bottom-width="0.3pt" border-bottom-style="solid" border-bottom-color="gray">
          <fo:block text-align="left" space-before.optimum="0.2cm">
            <xsl:value-of select="compte_charge"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.3pt" border-top-style="solid" border-top-color="gray" border-bottom-width="0.3pt" border-bottom-style="solid" border-bottom-color="gray">
          <fo:block text-align="left" space-before.optimum="0.2cm">
        ...
        <fo:table-cell border-top-width="0.3pt" border-top-style="solid" border-top-color="gray" border-bottom-width="0.3pt" border-bottom-style="solid" border-bottom-color="gray">
          <fo:block text-align="right" space-before.optimum="0.2cm">
            <xsl:value-of select="solde_charge"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.3pt" border-top-style="solid" border-top-color="gray" border-bottom-width="0.3pt" border-bottom-style="solid" border-bottom-color="gray">
          <fo:block text-align="left" space-before.optimum="0.2cm">
            <xsl:value-of select="compte_produit"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.3pt" border-top-style="solid" border-top-color="gray" border-bottom-width="0.3pt" border-bottom-style="solid" border-bottom-color="gray">
          <fo:block text-align="left" space-before.optimum="0.2cm">
        ...
        <fo:table-cell border-top-width="0.3pt" border-top-style="solid" border-top-color="gray" border-bottom-width="0.3pt" border-bottom-style="solid" border-bottom-color="gray">
          <fo:block text-align="right" space-before.optimum="0.2cm">
            <xsl:value-of select="solde_produit"/>
          </fo:block>
        </fo:table-cell>
      </fo:table-row>
    </xsl:if>
