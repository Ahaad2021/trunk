...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  <xsl:template match="/">
    <fo:root>
      ...
      <xsl:apply-templates select="demande_tps"/>
    </fo:root>
  </xsl:template>
  ...
  <xsl:template match="demande_tps">
						...
						<fo:list-block>
							...
							<fo:list-item>
								...
								<fo:list-item-body>
									<fo:block space-before.optimum="0.3cm">
										Intitulé du compte:
										<xsl:value-of select="intitule_cpte_courant_src" />
									</fo:block>
								</fo:list-item-body>
							</fo:list-item>
							<fo:list-item>
								...
								<fo:list-item-body>
									<fo:block space-before.optimum="0.3cm">
										...
										<xsl:value-of select="num_cpte_courant_src" />
									</fo:block>
								</fo:list-item-body>
							</fo:list-item>
							<fo:list-item>
							...
							<fo:list-item>
								...
								<fo:list-item-body>
									<fo:block space-before.optimum="0.3cm">
										Nouveau solde de Parts sociales souscrites:
										<xsl:value-of select="solde_total_ps_sous" />
									</fo:block>
								</fo:list-item-body>
							</fo:list-item>
							<fo:list-item>
								...
								<fo:list-item-body>
									<fo:block space-before.optimum="0.3cm">
										Nouveau solde de Parts sociales libérée:
										<xsl:value-of select="solde_total_ps_lib" />
									</fo:block>
								</fo:list-item-body>
							</fo:list-item>
