        ...
        <fo:list-block>
            <fo:list-item>
                ...
                <fo:list-item-body>
                    <fo:block>
                        ...
                        Total number of dormant accounts : <xsl:value-of select="nombre_comptes_dormants_total"/>
                    </fo:block>
                </fo:list-item-body>
            </fo:list-item>
            ...
            <fo:list-item>
                ...
                <fo:list-item-body>
                    <fo:block>
                        <xsl:value-of select="$point_liste" disable-output-escaping="yes"/>
                        Total balance of dormant accounts : <xsl:value-of select="solde_comptes_dormants_total"/>
                    </fo:block>
                </fo:list-item-body>
            </fo:list-item>
        </fo:list-block>
        ...
        <fo:table border-collapse="collapse" border-separation.inline-progression-direction="10pt" width="100%" table-layout="fixed">
            ...
            <fo:table-header>
                <fo:table-row font-weight="bold">
                    ...
                    <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1" padding-before="2pt" padding-after="1pt">
                        <fo:block text-align="center">Account num.</fo:block>
                    </fo:table-cell>
                    <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1" padding-before="2pt" padding-after="1pt">
                    ...
                    <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1" padding-before="2pt" padding-after="1pt">
                        <fo:block text-align="center">Date blocked</fo:block>
                    </fo:table-cell>
                </fo:table-row>
            </fo:table-header>
            <fo:table-body>
    ...
    <xsl:template match="xml_total">
        <fo:table-row font-weight="bold">
            ...
            <fo:table-cell border="0.1pt solid black" padding-before="2pt" padding-after="2pt">
                <fo:block font-weight="bold" text-align="center" font-size="8pt">Sub Total</fo:block>
            </fo:table-cell>
            <fo:table-cell border="0.1pt solid black" padding-before="2pt" padding-after="2pt">
