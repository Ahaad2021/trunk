...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
    ...
    <fo:table>
      ...
      <fo:table-body>
        ...
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="encours_dir"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
        ...
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="encours_emp"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
        ...
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="encours_emp_dir"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="ratio_emp_dir"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="encours_retard_dir"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="ratio_retard_dir"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="encours_retard_emp"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="ratio_retard_emp"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="encours_retard_emp_dir"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="ratio_retard_emp_dir"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-body>
  ...
  <xsl:template match="epargne">
    <xsl:call-template name="titre_niv1">
      <xsl:with-param name="titre" select="'Ratios épargne'"/>
    </xsl:call-template>
    <fo:table>
      <fo:table-column column-width="10cm"/>
      <fo:table-column column-width="6cm"/>
      <fo:table-body>
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="ratio_epar_dir"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="ratio_epar_emp"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="ratio_epar_emp_dir"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-body>
  ...
  <xsl:template match="details_dir">
    <xsl:call-template name="titre_niv1">
      <xsl:with-param name="titre" select="'Informations détaillées dirigeants'"/>
    </xsl:call-template>
    <fo:table border-collapse="separate" width="100%" table-layout="fixed">
      ...
      <fo:table-header>
        <fo:table-row font-weight="bold">
          ...
          <fo:table-cell>
            <fo:block text-align="right">Outstanding loan</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block text-align="right">Next CSV</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block text-align="center">Loan status</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block text-align="right">Penalties expected</fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-header>
      <fo:table-body>
  ...
  <xsl:template match="details_emp">
    <xsl:call-template name="titre_niv1">
      <xsl:with-param name="titre" select="'Informations détaillées employés'"/>
    </xsl:call-template>
    ...
    <fo:table-row>
      <xsl:choose>
        <xsl:when test="groupe_gs='groupe'">
          ...
          <fo:table-cell border-width="0.2mm" border-style="solid">
            <fo:block font-weight="bold" text-align="right">
              <xsl:value-of select="cv_encours_client"/>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell border-width="0.2mm" border-style="solid">
            <fo:block font-weight="bold" text-align="center">
