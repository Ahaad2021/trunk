  ...
  <xsl:template match="body">
    <fo:list-block>
      ...
      <xsl:if test="nom_agence_remote">
        <fo:list-item>
          ...
          <fo:list-item-body>
            <fo:block space-before.optimum="0.3cm">External agency : <xsl:value-of select="nom_agence_remote"/></fo:block>
          </fo:list-item-body>
        </fo:list-item>
      </xsl:if>
      ...
      <xsl:if test="/recu/@type='6' or /recu/@type='8' or /recu/@type='40'">
        <xsl:if test="frais">
          <fo:list-item>
            ...
            <fo:list-item-body>
              <fo:block space-before.optimum="0.3cm">Withdrawal/Deposit fee : <xsl:value-of select="frais"/></fo:block>
            </fo:list-item-body>
          </fo:list-item>
        </xsl:if>
   ...
   <xsl:if test="hasBilletage">
   	    <fo:list-item>
	            ...
	            <fo:list-item-body><fo:block space-before.optimum="0.1cm">Notes : </fo:block></fo:list-item-body>
	    </fo:list-item>
