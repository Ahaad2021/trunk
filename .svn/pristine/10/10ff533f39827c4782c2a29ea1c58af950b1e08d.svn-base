...
FROM (
select mvt.date_valeur,cpte.id_cpte,cpte.id_titulaire,cpte.etat_cpte,cpte.solde,mvt.id_ag, id_his_param as id_his,'admin'::text as login,501 as type_fonction 
from ad_cpt cpte
