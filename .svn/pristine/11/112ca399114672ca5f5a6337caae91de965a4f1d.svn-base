  ...
  <xsl:template match="body">
    <fo:list-block>
      ...
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.3cm">Complete number of client account: <xsl:value-of select="compteRecharge"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
      ...
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.3cm">Amount requested: <xsl:value-of select="montant"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
      ...
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.3cm">Request date: <xsl:value-of select="dateDmde"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
    </fo:list-block>
    <fo:block space-before.optimum="0.7cm"/>
