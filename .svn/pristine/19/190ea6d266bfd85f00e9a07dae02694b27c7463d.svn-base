...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  ...
  <xsl:template match="infos_globales">
    ...
    <fo:table border-collapse="collapse" border-separation.inline-progression-direction="10pt" width="100%" table-layout="fixed">
      ...
      <fo:table-body>
        <fo:table-row>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">Beginning period : </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
        ...
        <fo:table-row>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">End period : </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
        ...
        <fo:table-row>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">Person responsible : </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
        ...
        <fo:table-row>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">Structure type : </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="type_structure"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">Agreement date : </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="date_agrement"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">Agreement N° : </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="num_agrement"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-body>
  ...
  <xsl:template match="ratio_prud">
    <xsl:call-template name="titre_niv1">
      <xsl:with-param name="titre" select="'Prudential ratios (%)'"/>
    </xsl:call-template>
  ...
  <xsl:template match="indic_perf">
    <xsl:call-template name="titre_niv1">
      <xsl:with-param name="titre" select="'Portfolio quality (%)'"/>
    </xsl:call-template>
    <fo:table width="100%" table-layout="fixed">
      <fo:table-column column-width="proportional-column-width(1)"/>
      <fo:table-column column-width="proportional-column-width(1)"/>
  ...
  <xsl:template match="couverture">
    <xsl:call-template name="titre_niv1">
      <xsl:with-param name="titre" select="'Coverage'"/>
    </xsl:call-template>
    <fo:table width="100%" table-layout="fixed">
      <fo:table-column column-width="proportional-column-width(1)"/>
      <fo:table-column column-width="proportional-column-width(1)"/>
      <fo:table-body>
        <fo:table-row>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="nbr_credits"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="portefeuille"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="nbre_cpt_epargne"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="total_epargne"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
        ...
        <fo:table-row>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="first_credit_moyen"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="first_credit_median"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="credit_moyen"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="credit_median"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="epargne_moyen_cpte"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="epargne_median_cpte"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="epargne_moyen_client"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="epargne_median_client"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-body>
  ...
  <xsl:template match="indic_productivite">
    <xsl:call-template name="titre_niv1">
      <xsl:with-param name="titre" select="'Productivity'"/>
    </xsl:call-template>
    <fo:table width="100%" table-layout="fixed">
      <fo:table-column column-width="proportional-column-width(1)"/>
      <fo:table-column column-width="proportional-column-width(1)"/>
  ...
  <xsl:template match="indic_impact">
    <xsl:call-template name="titre_niv1">
      <xsl:with-param name="titre" select="'Impact'"/>
    </xsl:call-template>
    <fo:table width="100%" table-layout="fixed">
      ...
      <fo:table-header>
        <fo:table-row font-weight="bold">
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">Saver</fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">Borrowers</fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">Total for the clients</fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-header>
      <fo:table-body>
        <fo:table-row>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="epargnants/nbre_individus/nbre_pp"/>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="emprunteurs/nbre_individus/nbre_pp"/>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="clients/nbre_individus/nbre_pp"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
        ...
        <fo:table-row>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="epargnants/nbre_individus/nbre_pm"/>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="emprunteurs/nbre_individus/nbre_pm"/>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="clients/nbre_individus/nbre_pm"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">Informal groups</fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="epargnants/nbre_individus/nbre_gi"/>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="emprunteurs/nbre_individus/nbre_gi"/>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="clients/nbre_individus/nbre_gi"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">Joint groups</fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="epargnants/nbre_individus/nbre_gs"/>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="emprunteurs/nbre_individus/nbre_gs"/>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="clients/nbre_individus/nbre_gs"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row font-weight="bold">
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="epargnants/nbre_individus/nbre_total"/>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="emprunteurs/nbre_individus/nbre_total"/>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">
              <xsl:value-of select="clients/nbre_individus/nbre_total"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-body>
    ...
    <fo:table width="100%" table-layout="fixed">
      ...
      <fo:table-body>
        <fo:table-row>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block font-weight="bold" text-align="center">Average number of borrower members</fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
        ...
        <fo:table-row>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block font-weight="bold" text-align="center">Total number of borrower members</fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
