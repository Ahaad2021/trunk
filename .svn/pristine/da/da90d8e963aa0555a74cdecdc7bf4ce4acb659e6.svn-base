        ...
        <fo:table border-collapse="collapse" border-separation.inline-progression-direction="10pt" width="100%" table-layout="fixed" space-before="0.2in">
            ...
            <fo:table-header>
                <fo:table-row font-weight="bold">
                    ...
                    <fo:table-cell display-align="center" border="0.1pt solid gray">
                        <fo:block text-align="center">Nom Agence</fo:block>
                    </fo:table-cell>
                    <!--<fo:table-cell display-align="center" border="0.1pt solid gray">
                        <fo:block text-align="center">Date du Rapport</fo:block>
                    </fo:table-cell>-->
                    <fo:table-cell display-align="center" border="0.1pt solid gray">
                        <fo:block text-align="center">Etat de la Compensation</fo:block>
                    </fo:table-cell>
                    <fo:table-cell display-align="center" border="0.1pt solid gray">
                        <fo:block text-align="center">Date dernière compensation</fo:block>
                    </fo:table-cell>
                    <fo:table-cell display-align="center" border="0.1pt solid gray">
                        <fo:block text-align="center">Date dernière compensation réussie</fo:block>
                    </fo:table-cell>
                </fo:table-row>
            </fo:table-header>
