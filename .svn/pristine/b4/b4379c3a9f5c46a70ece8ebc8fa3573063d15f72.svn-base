				...
				<fo:table-cell display-align="center" border="0.1pt solid gray">
					<fo:table border="none"  width="100%" table-layout="fixed">
					   ...
					   <fo:table-column column-width="proportional-column-width(3)"/>
						...
						<fo:table-row>
							<fo:table-cell display-align="center" border="0.1pt solid gray">
								<fo:block text-align="center">N° écriture</fo:block>
							</fo:table-cell>
							<fo:table-cell display-align="center" border="0.1pt solid gray">
...
<xsl:template match="his_data">
		...
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block text-align="center"><xsl:value-of select="fonction"/></fo:block>
		</fo:table-cell>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block text-align="right"><xsl:value-of select="login"/></fo:block>
		</fo:table-cell>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
...
<xsl:template match="ligne_ecritures">
	<fo:table border="none" width="100%" table-layout="fixed">
		...
		<fo:table-row>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block text-align="left"><xsl:value-of select="num_ecriture"/></fo:block>
		</fo:table-cell>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block text-align="right"><xsl:value-of select="libel_ecriture"/></fo:block>
		</fo:table-cell>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
...
<fo:table border="none"  width="100%" table-layout="fixed">
		...
		<fo:table-row>
			<fo:table-cell display-align="center" border="0.1pt solid gray">
				<fo:block text-align="center"><xsl:value-of select="compte"/></fo:block>
			</fo:table-cell>
			<fo:table-cell display-align="center" border="0.1pt solid gray">
				<fo:block text-align="center"><xsl:value-of select="compte_client"/></fo:block>
			</fo:table-cell>
			<fo:table-cell display-align="center" border="0.1pt solid gray">
