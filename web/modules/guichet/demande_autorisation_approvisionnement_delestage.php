...
if ($global_nom_ecran == "Aad-1") {
  global $global_id_client;

  $my_page = new HTML_GEN2(_("Liste de demandes d'approvisionnement/délestage"));
  ...
  // Header row
  $my_page->addField("checkall_valid","<span style='width: 40px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-bottom-width: 1px;border-right-width: 1px;border-bottom-style: solid;border-right-style: solid;border-bottom-color: #007777;border-right-color: #007777;font-weight: bold;'>N°</span><span style='width: 180px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-bottom-width: 1px;border-right-width: 1px;border-bottom-style: solid;border-right-style: solid;border-bottom-color: #007777;border-right-color: #007777;font-weight: bold;'>Guichet</span><span style='width: 200px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-bottom-width: 1px;border-right-width: 1px;border-bottom-style: solid;border-right-style: solid;border-bottom-color: #007777;border-right-color: #007777;font-weight: bold;'>Action Demandé</span><span style='width: 130px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-bottom-width: 1px;border-right-width: 1px;border-bottom-style: solid;border-right-style: solid;border-bottom-color: #007777;border-right-color: #007777;font-weight: bold;'>Montant</span><span style='width: 130px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-bottom-width: 1px;border-right-width: 1px;border-bottom-style: solid;border-right-style: solid;border-bottom-color: #007777;border-right-color: #007777;font-weight: bold;'>Date demande</span>", TYPC_BOL);
  ...
  foreach ($listeDemandeApproDelestage as $id => $demandeApproDelestage) {
    ...
    $info_guichet= get_guichet_infos($demandeApproDelestage["id_guichet"]);
    $nom_guichet = $info_guichet['libel_gui'];
    $action_demande = adb_gettext($adsys["adsys_type_flux"][$demandeApproDelestage["type_action"]]);
    $montant = afficheMontant($demandeApproDelestage["montant"])." ".$demandeApproDelestage["devise"];
    $date_demande = pg2phpDate($demandeApproDelestage["date_creation"]);
    /*$details = '<a href = "#" onClick ="';
    $idBenef = $SESSION_VARS["id_beneficiaire"];
    $details .= "OpenBrw('$SERVER_NAME/modules/guichet/details_benef_transfert.php?id_trans=".$id_demande."&id_client=".$id_client."');return false;";
    ...
    $libelle_demande = sprintf("<span style='width: 40px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-right-width: 1px;border-right-style: solid;border-right-color: #007777;'>%s</span><span style='width: 180px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-right-width: 1px;border-right-style: solid;border-right-color: #007777;'>%s</span><span style='width: 200px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-right-width: 1px;border-right-style: solid;border-right-color: #007777;'>%s</span><span style='width: 130px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-right-width: 1px;border-right-style: solid;border-right-color: #007777;'>%s</span><span style='width: 130px;padding-left: 10px;padding-right: 10px;text-align: center;display: block;float: left;border-right-width: 1px;border-right-style: solid;border-right-color: #007777;'>%s</span>", $id_demande,$nom_guichet, $action_demande, $montant, $date_demande);
  ...
  $my_page->setFormButtonProperties("btn_process_demande", BUTP_PROCHAIN_ECRAN, 'Aad-2');
...
elseif ($global_nom_ecran == "Aad-2") {

  $erreur = processAutorisationApprovisionnementDelestage($_POST);

  if ($erreur->errCode == NO_ERR) {

    // Affichage de la confirmation
    $html_msg = new HTML_message("Confirmation autorisation approvisionnement/delestage");

    if ($erreur->param > 1){
      $demande_msg = "demandes  approvisionnements/delestages ont été traitées";
    } else {
      $demande_msg = "demande approvisionnement/delestage a été traitée";
    }
