...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:php="http://php.net/xsl" version="1.0">
  ...
  <xsl:template match="produit">
    <xsl:call-template name="titre_niv1">
      <xsl:with-param name="titre"><xsl:value-of select="lib_prod"/></xsl:with-param>
    </xsl:call-template>
    <fo:table border-collapse="collapse" border-separation.inline-progression-direction="5pt" width="100%" table-layout="fixed">
      ...
      <fo:table-header>
        <fo:table-row>
          ...
          <fo:table-cell number-columns-spanned="3">
            <fo:block font-weight="bold" text-align="center">Impayé</fo:block>
          </fo:table-cell>
          <fo:table-cell number-columns-spanned="2">
          ...
          <fo:table-cell >
            <fo:block font-weight="bold" text-align="right">Etat</fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
          <fo:table-cell>
          ...
          <fo:table-cell>
            <fo:block font-weight="bold">Numero Client</fo:block>
          </fo:table-cell>
          <fo:table-cell>
          ...
          <fo:table-cell>
            <fo:block font-weight="bold" text-align="right">Intérêts</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block font-weight="bold" text-align="right">Garantie</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block font-weight="bold" text-align="right">Pénalités</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block font-weight="bold" text-align="right">Capital</fo:block>
          </fo:table-cell>
          ...
          <fo:table-cell>
            <fo:block font-weight="bold" text-align="left">Garantie</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block font-weight="bold" text-align="right">échéance</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block font-weight="bold" text-align="right">jours</fo:block>
          </fo:table-cell>
          <fo:table-cell>
          ...
          <fo:table-cell>
            <fo:block font-weight="bold" text-align="right">crédit</fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-header>
      <fo:table-body>
  ...
  <xsl:template match="infos_synthetiques">
    ...
    <fo:list-block>
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block><xsl:value-of select="$point_liste" disable-output-escaping="yes"/>Nombre de crédits en cours: <xsl:value-of select="nbre_credits"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
    </fo:list-block>
    <fo:list-block>
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block><xsl:value-of select="$point_liste" disable-output-escaping="yes"/>Nombre de credits en retard: <xsl:value-of select="nbre_credits_retard"/> (<xsl:value-of select="prc_credits_retard"/>)</fo:block>
        </fo:list-item-body>
      </fo:list-item>
    </fo:list-block>
    <fo:list-block>
    ...
    <fo:list-block>
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block><xsl:value-of select="$point_liste" disable-output-escaping="yes"/>Portefeuille en retard: <xsl:value-of select="total_solde_cap"/> (<xsl:value-of select="prc_portefeuille_retard"/>)</fo:block>
        </fo:list-item-body>
      </fo:list-item>
    </fo:list-block>
    <fo:list-block>
