...
<xsl:template match="gestionnaire">
			<xsl:call-template name="titre_niv1"><xsl:with-param name="titre"><xsl:value-of select="agent_gest"/></xsl:with-param></xsl:call-template>
			<fo:table border-collapse="collapse" border-separation.inline-progression-direction="10pt" width="100%" table-layout="fixed">
				...
				<fo:table-header>
					<fo:table-row font-weight="bold">
						...
						<fo:table-cell display-align="center" border="0.1pt solid black" border-left-width="1px"  border-top-width="1px" border-right-width="1px" border-bottom-width="1px" border-style="solid">
							<fo:block text-align="center">Détail</fo:block>
						</fo:table-cell>
						<fo:table-cell display-align="center" border="0.1pt solid black" border-left-width="1px"  border-top-width="1px" border-right-width="1px" border-bottom-width="1px" border-style="solid">
...
<xsl:template match="infosCreditSolidiaire">
    ...
    <fo:table-cell display-align="center" border="0.1pt solid black" border-top-width="0.5px" border-style="solid">
			<fo:block text-align="right" font-weight="bold"><xsl:value-of select="montant_dde"/>  <xsl:value-of select="devise"/></fo:block>
		</fo:table-cell>
    <fo:table-cell display-align="center" border="0.1pt solid black" border-top-width="0.5px" border-style="solid">
			<fo:block text-align="left" font-weight="bold"><xsl:value-of select="obj_dde"/></fo:block>
		</fo:table-cell>
    <fo:table-cell display-align="center" border="0.1pt solid black" border-top-width="0.5px" border-style="solid">
			<fo:block text-align="left" wrap-option="no-wrap" font-weight="bold"><xsl:value-of select="detail_obj_dde"/></fo:block>
		</fo:table-cell>
    <fo:table-cell display-align="center" border="0.1pt solid black" border-top-width="0.5px" border-style="solid">
    ...
    <fo:table-cell display-align="center" border="0.1pt solid black" border-top-width="0.5px" border-right-width="0.5px" border-style="solid">
			<fo:block text-align="center" wrap-option="no-wrap" font-weight="bold"><xsl:value-of select="etat"/></fo:block>
		</fo:table-cell>
	</fo:table-row>
</xsl:template>
...
<fo:table-cell display-align="center" border="0.1pt solid black" border-left-width="0.5px" border-style="solid">
		    ...
		    <fo:table-cell display-align="center" border="0.1pt solid gray">
				...
				<fo:table-cell display-align="center" border="0.1pt solid gray">
					<fo:block text-align="right" font-style="italic"><xsl:value-of select="montant_dde"/> <xsl:value-of select="devise"/></fo:block>
				</fo:table-cell>
				<fo:table-cell display-align="center" border="0.1pt solid gray">
					<fo:block text-align="left" font-style="italic"><xsl:value-of select="obj_dde"/></fo:block>
				</fo:table-cell>
				<fo:table-cell display-align="center" border="0.1pt solid gray">
					<fo:block text-align="left" wrap-option="no-wrap" font-style="italic"><xsl:value-of select="detail_obj_dde"/></fo:block>
				</fo:table-cell>
				<fo:table-cell display-align="center" border="0.1pt solid gray">
				...
				<fo:table-cell display-align="center" border="0.1pt solid black" border-right-width="0.5px" border-style="solid">
					<fo:block text-align="center" wrap-option="no-wrap" font-style="italic"><xsl:value-of select="etat"/></fo:block>
				</fo:table-cell>
			</fo:table-row>
		</xsl:when>
  	<xsl:otherwise>
		    ...
		    <fo:table-cell display-align="center" border="0.1pt solid black" border-left-width="0.5px"  border-top-width="0.5px" border-right-width="0.5px" border-bottom-width="0.5px" border-style="solid">
					<fo:block text-align="right"><xsl:value-of select="montant_dde"/>  <xsl:value-of select="devise"/></fo:block>
				</fo:table-cell>
		    <fo:table-cell display-align="center" border="0.1pt solid black" border-left-width="0.5px"  border-top-width="0.5px" border-right-width="0.5px" border-bottom-width="0.5px" border-style="solid">
					<fo:block text-align="left"><xsl:value-of select="obj_dde"/></fo:block>
				</fo:table-cell>
		    <fo:table-cell display-align="center" border="0.1pt solid black" border-left-width="0.5px"  border-top-width="0.5px" border-right-width="0.5px" border-bottom-width="0.5px" border-style="solid">
					<fo:block text-align="left" wrap-option="no-wrap"><xsl:value-of select="detail_obj_dde"/></fo:block>
				</fo:table-cell>
		    <fo:table-cell display-align="center" border="0.1pt solid black" border-left-width="0.5px"  border-top-width="0.5px" border-right-width="0.5px" border-bottom-width="0.5px" border-style="solid">
					<fo:block text-align="center"><xsl:value-of select="duree"/></fo:block>
				</fo:table-cell>
		    <fo:table-cell display-align="center" border="0.1pt solid black" border-left-width="0.5px"  border-top-width="0.5px" border-right-width="0.5px" border-bottom-width="0.5px" border-style="solid">
					<fo:block text-align="center" wrap-option="no-wrap"><xsl:value-of select="etat"/></fo:block>
				</fo:table-cell>
			</fo:table-row>
		</xsl:otherwise>
	</xsl:choose>
    ...
    <fo:table border-collapse="separate" border-separation.inline-progression-direction="10pt" width="40%" table-layout="fixed">
      ...
      <fo:table-column column-width="proportional-column-width(1)"/>
        <fo:table-body>
          <fo:table-row>
                <fo:table-cell>
			<fo:block text-align="left" font-weight="bold">Nombre total de crédits</fo:block>
		</fo:table-cell>
		<fo:table-cell>
			<fo:block text-align="left"><xsl:value-of select="nb_total_credit"/> </fo:block>
		</fo:table-cell>
          </fo:table-row>
          <fo:table-row>
                <fo:table-cell>
			<fo:block text-align="left" font-style="italic">Nombre de crédits ordinaires</fo:block>
		</fo:table-cell>
 		<fo:table-cell>
			<fo:block text-align="left" font-style="italic"><xsl:value-of select="nb_credit_ordinaire"/></fo:block>
		</fo:table-cell>
          </fo:table-row>
          <fo:table-row>
                <fo:table-cell>
			<fo:block text-align="left" font-style="italic">Nombre de crédits solidaires</fo:block>
		</fo:table-cell>
		<fo:table-cell>
			<fo:block text-align="left" font-style="italic"><xsl:value-of select="nb_credit_solidaire"/></fo:block>
		</fo:table-cell>
          </fo:table-row>
          <fo:table-row>
                <fo:table-cell>
			<fo:block text-align="left" font-weight="bold">Montant total des crédits</fo:block>
		</fo:table-cell>
		<fo:table-cell>
			<fo:block text-align="left"><xsl:value-of select="mnt_total_credit"/> </fo:block>
		</fo:table-cell>
          </fo:table-row>
          <fo:table-row>
                <fo:table-cell>
			<fo:block text-align="left" font-style="italic">Montant des crédits ordinaires</fo:block>
		</fo:table-cell>
 		<fo:table-cell>
			<fo:block text-align="left" font-style="italic"><xsl:value-of select="mnt_credit_ordinaire"/></fo:block>
		</fo:table-cell>
          </fo:table-row>
          <fo:table-row>
                <fo:table-cell>
			<fo:block text-align="left" font-style="italic">Montant des crédits solidaires</fo:block>
		</fo:table-cell>
		<fo:table-cell>
			<fo:block text-align="left" font-style="italic"><xsl:value-of select="mnt_credit_solidaire"/></fo:block>
		</fo:table-cell>
          </fo:table-row>
        </fo:table-body>
    </fo:table>
