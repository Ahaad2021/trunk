...
<xsl:template match="gestionnaire">
  <xsl:call-template name="titre_niv1"><xsl:with-param name="titre"><xsl:value-of select="nom_gestionnaire"/></xsl:with-param></xsl:call-template>
...
<xsl:template match="client">
	<fo:table-row>
    		...
    		<fo:table-cell display-align="center" border="0.1pt solid black" number-rows-spanned="2" border-left-width="0.8px" border-top-width="0.8px" border-bottom-width="0.8px" border-style="solid">
    			<fo:block font-weight="bold" text-align="center"><xsl:value-of select="num_client"/></fo:block>
    		</fo:table-cell>
    		<fo:table-cell display-align="center" border="0.1pt solid black" padding-left="3pt" border-top-width="0.8px" border-style="solid">
    			<fo:block font-weight="bold" text-align="left"><xsl:value-of select="nom_client"/></fo:block>
    		</fo:table-cell>
    		<fo:table-cell display-align="center" border="0.1pt solid black" padding-left="3pt" border-top-width="0.8px" border-style="solid">
            	<fo:block font-weight="bold" text-align="left"><xsl:value-of select="localite"/></fo:block>
        	</fo:table-cell>
        	<fo:table-cell display-align="center" border="0.1pt solid black" padding-left="3pt" number-columns-spanned="7" border-top-width="0.8px" border-right-width="0.8px" border-style="solid">
                <fo:block font-weight="bold" text-align="left"><xsl:value-of select="adresse"/></fo:block>
        	</fo:table-cell>
    		</xsl:when>
    		<xsl:when test="membre_gs='membre'">
    		<fo:table-cell display-align="center" border="0.1pt solid black" number-rows-spanned="2" border-left-width="0.8px" border-top-width="0.8px" border-bottom-width="0.8px" border-style="solid">
    			<fo:block font-style="oblique" font-weight="500" text-align="center"><xsl:value-of select="num_client"/></fo:block>
    		</fo:table-cell>
    		<fo:table-cell display-align="center" border="0.1pt solid black" padding-left="3pt" border-top-width="0.8px" border-style="solid">
    			<fo:block font-style="oblique" font-weight="500" text-align="left"><xsl:value-of select="nom_client"/></fo:block>
    		</fo:table-cell>
    		<fo:table-cell display-align="center" border="0.1pt solid black" padding-left="3pt" border-top-width="0.8px" border-style="solid">
            	<fo:block font-style="oblique" font-weight="500" text-align="left"><xsl:value-of select="localite"/></fo:block>
        	</fo:table-cell>
        	<fo:table-cell display-align="center" border="0.1pt solid black" padding-left="3pt" number-columns-spanned="7" border-top-width="0.8px" border-right-width="0.8px" border-style="solid">
                <fo:block font-style="oblique" font-weight="500" text-align="left"><xsl:value-of select="adresse"/></fo:block>
        	</fo:table-cell>
    		</xsl:when>
    		<xsl:otherwise>
    			<fo:table-cell display-align="center" border="0.1pt solid black" number-rows-spanned="2" border-left-width="0.8px" border-top-width="0.8px" border-bottom-width="0.8px" border-style="solid">
    			...
    			<fo:table-cell display-align="center" border="0.1pt solid black" padding-left="3pt" border-top-width="0.8px" border-style="solid">
                	<fo:block text-align="left"><xsl:value-of select="localite"/></fo:block>
        		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" padding-left="3pt" number-columns-spanned="7" border-top-width="0.8px" border-right-width="0.8px" border-style="solid">
                	<fo:block text-align="left"><xsl:value-of select="adresse"/></fo:block>
        		</fo:table-cell>
    		</xsl:otherwise>
    	</xsl:choose>
  </fo:table-row>
  <fo:table-row>
  		<xsl:choose>
  			<xsl:when test="groupe_gs='groupe'">
                  ...
                  <fo:block font-weight="bold" text-align="center"><xsl:value-of select="num_dossier"/></fo:block>
          		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" padding-left="3pt" border-bottom-width="0.8px" border-style="solid">
                	<fo:block font-weight="bold" text-align="left"><xsl:value-of select="libel_prod"/></fo:block>
        		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black"  padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
          		...
          		<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                  <fo:block font-weight="bold" text-align="right"><xsl:value-of select="mnt_dem"/></fo:block>
          		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                	<fo:block font-weight="bold" text-align="right"><xsl:value-of select="cre_mnt_octr"/></fo:block>
        		</fo:table-cell>
          		<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                  <fo:block font-weight="bold" text-align="right"><xsl:value-of select="capital_du"/></fo:block>
          		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                	<fo:block font-weight="bold" text-align="right"><xsl:value-of select="solde_int"/></fo:block>
        		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                	<fo:block font-weight="bold" text-align="center"><xsl:value-of select="cre_date_approb"/></fo:block>
        		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" border-bottom-width="0.8px" border-right-width="0.8px" border-style="solid">
                	<fo:block font-weight="bold" text-align="center"><xsl:value-of select="delai"/></fo:block>
          		</fo:table-cell>
  			</xsl:when>
  			<xsl:when test="membre_gs='membre'">
  				<fo:table-cell display-align="center" border="0.1pt solid black" border-bottom-width="0.8px" border-style="solid">
                  <fo:block font-style="oblique" font-weight="500" text-align="center"><xsl:value-of select="num_dossier"/></fo:block>
          		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" padding-left="3pt" border-bottom-width="0.8px" border-style="solid">
                	<fo:block font-style="oblique" font-weight="500" text-align="left"><xsl:value-of select="libel_prod"/></fo:block>
        		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black"  padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                	<fo:block font-style="oblique" font-weight="500" text-align="center"><xsl:value-of select="cre_etat"/></fo:block>
        		</fo:table-cell>
         		 <fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                  <fo:block font-style="oblique" font-weight="500" text-align="right"><xsl:value-of select="mnt_dem"/></fo:block>
          		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                	<fo:block font-style="oblique" font-weight="500" text-align="right"><xsl:value-of select="cre_mnt_octr"/></fo:block>
        		</fo:table-cell>
          		<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                  <fo:block font-style="oblique" font-weight="500" text-align="right"><xsl:value-of select="capital_du"/></fo:block>
          		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                	<fo:block font-style="oblique" font-weight="500" text-align="right"><xsl:value-of select="solde_int"/></fo:block>
        		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                	<fo:block font-style="oblique" font-weight="500" text-align="center"><xsl:value-of select="cre_date_approb"/></fo:block>
        		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" border-bottom-width="0.8px" border-right-width="0.8px" border-style="solid">
                	<fo:block font-style="oblique" font-weight="500" text-align="center"><xsl:value-of select="delai"/></fo:block>
          		</fo:table-cell>
  			</xsl:when>
  			<xsl:otherwise>
  				<fo:table-cell display-align="center" border="0.1pt solid black" border-bottom-width="0.8px" border-style="solid">
                  <fo:block text-align="center"><xsl:value-of select="num_dossier"/></fo:block>
          		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" padding-left="3pt" border-bottom-width="0.8px" border-style="solid">
                	<fo:block text-align="left"><xsl:value-of select="libel_prod"/></fo:block>
        		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black"  padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                	<fo:block text-align="center"><xsl:value-of select="cre_etat"/></fo:block>
        		</fo:table-cell>
          		<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                  <fo:block text-align="right"><xsl:value-of select="mnt_dem"/></fo:block>
          		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                	<fo:block text-align="right"><xsl:value-of select="cre_mnt_octr"/></fo:block>
        		</fo:table-cell>
          		<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                  <fo:block text-align="right"><xsl:value-of select="capital_du"/></fo:block>
          		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                	<fo:block text-align="right"><xsl:value-of select="solde_int"/></fo:block>
        		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt" border-bottom-width="0.8px" border-style="solid">
                	<fo:block text-align="center"><xsl:value-of select="cre_date_approb"/></fo:block>
        		</fo:table-cell>
        		<fo:table-cell display-align="center" border="0.1pt solid black" border-bottom-width="0.8px" border-right-width="0.8px" border-style="solid">
                	<fo:block text-align="center"><xsl:value-of select="delai"/></fo:block>
          		</fo:table-cell>
  			</xsl:otherwise>
  		</xsl:choose>
  </fo:table-row>
...
<xsl:template match="sous_total">
	<xsl:call-template name="titre_niv1"><xsl:with-param name="titre" select="'Sous Total'"/></xsl:call-template>
	<fo:table border-collapse="collapse" border-separation.inline-progression-direction="10pt" width="100%" table-layout="fixed">
	<fo:table-column column-width="proportional-column-width(1)"/>
	<fo:table-column column-width="proportional-column-width(1)"/>
	<fo:table-column column-width="proportional-column-width(1)"/>
	...
	<fo:table-body>
  		<fo:table-row font-weight="bold">
          <fo:table-cell display-align="center" border="0.1pt solid black">
                  <fo:block font-weight="bold" text-align="center"><xsl:value-of select="prod_nombre"/></fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt">
                  <fo:block font-weight="bold" text-align="right"><xsl:value-of select="prod_montant"/></fo:block>
          </fo:table-cell>
        	<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt">
                <fo:block font-weight="bold" text-align="right"><xsl:value-of select="prod_devise"/></fo:block>
        	</fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt">
                  <fo:block font-weight="bold" text-align="right"><xsl:value-of select="prod_capital"/></fo:block>
          </fo:table-cell>
        	<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt">
                <fo:block font-weight="bold" text-align="right"><xsl:value-of select="prod_interet"/></fo:block>
        	</fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt">
                  <fo:block font-weight="bold" text-align="right"><xsl:value-of select="prod_garantie"/></fo:block>
          </fo:table-cell>
        	<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt">
                <fo:block font-weight="bold" text-align="right"><xsl:value-of select="prod_penalite"/></fo:block>
        	</fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt">
                  <fo:block font-weight="bold" text-align="right"><xsl:value-of select="prod_total_remb"/></fo:block>
          </fo:table-cell>
        	<fo:table-cell display-align="center" border="0.1pt solid black" padding-right="3pt">
                <fo:block font-weight="bold" text-align="right"><xsl:value-of select="prod_capital_du"/></fo:block>
        	</fo:table-cell>
  			</fo:table-row>
		</fo:table-body>
</fo:table>
...
<xsl:template match="total">
  <xsl:call-template name="titre_niv1"><xsl:with-param name="titre" select="'Total'"/></xsl:call-template>
    <fo:table border-collapse="separate" border-separation.inline-progression-direction="10pt" width="40%" table-layout="fixed">
      ...
      <fo:table-column column-width="proportional-column-width(1)"/>
		...
		<fo:table-cell>
 		...
 		<fo:table-cell>
			<fo:block text-align="right" font-weight="bold"><xsl:value-of select="montant"/></fo:block>
		</fo:table-cell>
          </fo:table-row>
          <fo:table-row>
                <fo:table-cell>
		...
		<fo:table-cell>
			<fo:block text-align="right"><xsl:value-of select="interet"/></fo:block>
		</fo:table-cell>
          </fo:table-row>
          <fo:table-row>
                <fo:table-cell>
		...
		<fo:table-cell>
			<fo:block text-align="right"><xsl:value-of select="garantie"/></fo:block>
		</fo:table-cell>
          </fo:table-row>
          <fo:table-row>
                <fo:table-cell>
		...
		<fo:table-cell>
			<fo:block text-align="right"><xsl:value-of select="penalite"/></fo:block>
		</fo:table-cell>
          </fo:table-row>
          <fo:table-row>
                <fo:table-cell>
		...
		<fo:table-cell>
			<fo:block text-align="right" font-weight="bold"><xsl:value-of select="total_remb"/></fo:block>
		</fo:table-cell>
          </fo:table-row>
          <fo:table-row>
                <fo:table-cell>
		...
		<fo:table-cell>
			<fo:block text-align="right" font-weight="bold"><xsl:value-of select="capital_du"/></fo:block>
		</fo:table-cell>
          </fo:table-row>
        </fo:table-body>
    </fo:table>
