...
<xsl:template match="details">
		<xsl:call-template name="titre_niv1"><xsl:with-param name="titre" select="ladevise"/></xsl:call-template>
...
<xsl:template match="devise">		
	<fo:table-row>
	  <fo:table-cell display-align="center" border="0.1pt solid gray">
		...
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block  text-align="center"><xsl:value-of select="date_ouvert"/></fo:block>
		</fo:table-cell>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block  text-align="center"><xsl:value-of select="libel_prod_ep"/></fo:block>
		</fo:table-cell>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block  text-align="center"><xsl:value-of select="etat_cpte"/></fo:block>
		</fo:table-cell>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
...
<xsl:template match="total">
	<fo:table-row>		
		...
		<fo:table-cell display-align="center" border="0.1pt solid gray" >
			<fo:block text-align="center" font-weight="bold" wrap-option="no-wrap" ><xsl:value-of select="total_solde"/></fo:block>
		</fo:table-cell>
	</fo:table-row>	
</xsl:template>
</xsl:stylesheet>
