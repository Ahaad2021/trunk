...
<xsl:template match="devise">
	<fo:table-row>
		...
		<fo:table-cell>
			<fo:block><xsl:value-of select="pos_net"/></fo:block>
		</fo:table-cell>
 		<fo:table-cell>
			<fo:block><xsl:value-of select="taux_jour"/></fo:block>
		</fo:table-cell>
		<fo:table-cell>
			<fo:block><xsl:value-of select="cv"/></fo:block>
		</fo:table-cell>
 		<fo:table-cell>
			<fo:block><xsl:value-of select="var_taux"/></fo:block>
		</fo:table-cell>
		<fo:table-cell>
			<fo:block><xsl:value-of select="taux_moyen"/></fo:block>
		</fo:table-cell>
	</fo:table-row>
</xsl:template> 
