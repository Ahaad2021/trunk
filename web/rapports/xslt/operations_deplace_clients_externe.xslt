...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		<fo:root>
			...
			<xsl:apply-templates select="operations_deplace_clients_externe" />
		</fo:root>
	</xsl:template>

	<xsl:template match="operations_deplace_clients_externe">
		<fo:page-sequence master-reference="main" font-size="6pt" font-family="Helvetica">
			...
			<fo:flow flow-name="xsl-region-body">
				...
				<xsl:apply-templates select="summary/grand_summary" />
			</fo:flow>
		</fo:page-sequence>
	</xsl:template>
				...
				<fo:table-row font-weight="bold">
					...
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">
							Mouvements dans l'agence <xsl:value-of select="infos_agences/nom_agence_locale" />
						</fo:block>
					</fo:table-cell>
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">Mouvements dans les agences externes</fo:block>
					</fo:table-cell>
				</fo:table-row>
						...
						<fo:table border-collapse="collapse" width="100%" table-layout="fixed">
							...
							<fo:table-body>
								<fo:table-row font-weight="bold">
									...
									<fo:table-cell display-align="center" border="0.1pt solid gray">
										<fo:block text-align="center">Opérateur</fo:block>
									</fo:table-cell>

									<fo:table-cell display-align="center" border="0.1pt solid gray">
										<fo:block text-align="center">Agence</fo:block>
									</fo:table-cell>
										...
										<fo:table border="none" width="100%" table-layout="fixed">
											...
											<fo:table-body>
												<fo:table-row>
													...
													<fo:table-cell display-align="center" border="0.1pt solid gray">
														<fo:block text-align="center">Débit</fo:block>
													</fo:table-cell>
													<fo:table-cell display-align="center" border="0.1pt solid gray">
														<fo:block text-align="center">Crédit</fo:block>
													</fo:table-cell>
												</fo:table-row>
											</fo:table-body>
										</fo:table>
						...
						<fo:table border-collapse="collapse" width="100%" table-layout="fixed">
							...
							<fo:table-body>
								<fo:table-row font-weight="bold">
									...
									<fo:table-cell display-align="center" border="0.1pt solid gray">
										<fo:block text-align="center">Agences externes</fo:block>
									</fo:table-cell>
	...
	<xsl:template match="summary">
		<xsl:for-each select="rows_summary/row">
			...
			<fo:table border-collapse="collapse" width="88%" table-layout="fixed">
				...
				<fo:table-header>
					...
					<fo:table-row font-weight="bold">
						<fo:table-cell display-align="center" border="0.1pt solid gray">
							<fo:block text-align="center">
								Agence <xsl:value-of select="agence_locale" />
							</fo:block>
						</fo:table-cell>
						...
						<fo:table-cell display-align="center" border="0.1pt solid gray">						
							<fo:block text-align="center">
								Agence <xsl:value-of select="agence_externe" />
							</fo:block>					
						</fo:table-cell>
				...
				<fo:table-body>	
					<fo:table-row>				
						<fo:table-cell display-align="center" border="0.1pt solid gray">
							<fo:block text-align="center">
								Total des dépôts de l'agence <xsl:value-of select="agence_locale" /> dans l'agence <xsl:value-of select="agence_externe" />
							</fo:block>
						</fo:table-cell>
						...
						<fo:table-cell display-align="center" border="0.1pt solid gray">
							<fo:block text-align="center">								
								Total des dépôts de l'agence <xsl:value-of select="agence_locale" /> chez l'agence <xsl:value-of select="agence_externe" />						
							</fo:block>
						</fo:table-cell>	
					...
					<fo:table-row>				
						<fo:table-cell display-align="center" border="0.1pt solid gray">
							<fo:block text-align="center">								
								Total des retraits de l'agence <xsl:value-of select="agence_locale" /> dans l'agence <xsl:value-of select="agence_externe" />							
							</fo:block>
						</fo:table-cell>
						...
						<fo:table-cell display-align="center" border="0.1pt solid gray">
							<fo:block text-align="center">								
								Total des retraits de l'agence <xsl:value-of select="agence_locale" /> chez l'agence <xsl:value-of select="agence_externe" />							
							</fo:block>
						</fo:table-cell>	
	...
	<!-- start : grand_summary -->
	<xsl:template match="summary/grand_summary">			
		<fo:table border-collapse="collapse" width="44%" table-layout="fixed">
			<fo:table-column column-width="proportional-column-width(10)" />
			<fo:table-column column-width="proportional-column-width(3)" />	
			
			<fo:table-header>
				<!-- Empty row -->				
				<fo:table-row column-number="2">
					<fo:table-cell display-align="center">
						<fo:block text-align="left"> <fo:leader /> </fo:block>
					</fo:table-cell>
				</fo:table-row>
				...
				<fo:table-row font-weight="bold">
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">
							Agence <xsl:value-of select="agence" />
						</fo:block>
					</fo:table-cell>
			...
			<fo:table-body>	
				<fo:table-row>				
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">Total dépôts dans les agences externes</fo:block>
					</fo:table-cell>
							
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center"><xsl:value-of select="grand_total_depot" /></fo:block>
					</fo:table-cell>	
				</fo:table-row>					
				
				<fo:table-row>				
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">Total retraits dans les agences externes</fo:block>
					</fo:table-cell>
							
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center"><xsl:value-of select="grand_total_retrait" /></fo:block>
					</fo:table-cell>	
				</fo:table-row>
