...
<xsl:template match="echeances_CAT">
	<fo:page-sequence master-reference="main" font-size="10pt" font-family="Helvetica">
		...
		<fo:flow flow-name="xsl-region-body">
			...
			<xsl:call-template name="titre_niv1"><xsl:with-param name="titre" select="'Prévisions'"/></xsl:call-template>
		...
		<xsl:choose>
			<xsl:when test="@type_compte = 'Total'">
				<fo:table-cell padding-before="10pt" border-top-width="0.1pt" border-top-style="solid" border-top-color="black">
					<fo:block text-align="center"><xsl:value-of select="@type_compte"/></fo:block>
				</fo:table-cell>
			</xsl:when>
			<xsl:otherwise>
				<fo:table-cell display-align="center" border="0.1pt solid gray">
