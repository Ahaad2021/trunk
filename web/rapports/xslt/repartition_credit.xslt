...
<xsl:template match="infos_synthetiques">
	...
	<fo:list-block>
		<fo:list-item>
			...
			<fo:list-item-body><fo:block><xsl:value-of select="$point_liste" disable-output-escaping="yes"/>Critère: <xsl:value-of select="critere"/></fo:block></fo:list-item-body>
		</fo:list-item>
	</fo:list-block>
...
<xsl:template match="tranche">
	<fo:table-row>
		<fo:table-cell border-width="0.05mm" border-style="dashed">
			<fo:block><xsl:value-of select="lib_tranche"/></fo:block>
		</fo:table-cell>
		<fo:table-cell border-width="0.05mm" border-style="dashed">
			<fo:block text-align="right"><xsl:value-of select="nbre"/></fo:block>
			</fo:table-cell>
		<fo:table-cell border-width="0.05mm" border-style="dashed">
			<fo:block text-align="right"><xsl:value-of select="nbre_prc"/></fo:block>
		</fo:table-cell>
		<fo:table-cell border-width="0.05mm" border-style="dashed">
			<fo:block text-align="right"><xsl:value-of select="mnt"/></fo:block>
		</fo:table-cell>
		<fo:table-cell border-width="0.05mm" border-style="dashed">
			<fo:block text-align="right"><xsl:value-of select="mnt_prc"/></fo:block>
		</fo:table-cell>
		<fo:table-cell border-width="0.05mm" border-style="dashed">
			<fo:block text-align="right"><xsl:value-of select="retard"/></fo:block>
		</fo:table-cell>
		<fo:table-cell border-width="0.05mm" border-style="dashed">
			<fo:block text-align="right"><xsl:value-of select="retard_prc"/></fo:block>
		</fo:table-cell>
	</fo:table-row>
</xsl:template>
