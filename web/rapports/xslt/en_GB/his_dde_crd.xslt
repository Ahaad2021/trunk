    ...
    <fo:table border-collapse="collapse" border-separation.inline-progression-direction="10pt" width="100%" table-layout="fixed">
      ...
      <fo:table-header>
        <fo:table-row font-weight="bold">
          ...
          <fo:table-cell display-align="center" border="0.1pt solid black" border-left-width="1px" border-top-width="1px" border-right-width="1px" border-bottom-width="1px" border-style="solid">
            <fo:block text-align="center">Cur</fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid black" border-left-width="1px" border-top-width="1px" border-right-width="1px" border-bottom-width="1px" border-style="solid">
            <fo:block text-align="center">Object</fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid black" border-left-width="1px" border-top-width="1px" border-right-width="1px" border-bottom-width="1px" border-style="solid">
            <fo:block text-align="center">Most advanced status</fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid black" border-left-width="1px" border-top-width="1px" border-right-width="1px" border-bottom-width="1px" border-style="solid">
          ...
          <fo:table-cell display-align="center" border="0.1pt solid black" border-left-width="1px" border-top-width="1px" border-right-width="1px" border-bottom-width="1px" border-style="solid">
            <fo:block text-align="center">Date of decision</fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid black" border-left-width="1px" border-top-width="1px" border-right-width="1px" border-bottom-width="1px" border-style="solid">
            <fo:block text-align="center">Amount granted</fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid black" border-left-width="1px" border-top-width="1px" border-right-width="1px" border-bottom-width="1px" border-style="solid">
            <fo:block text-align="center">Motive</fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-header>
      <fo:table-body>
  ...
  <xsl:template match="infosCreditSolidiaire">
    <fo:table-row>
      ...
      <fo:table-cell display-align="center" border="0.1pt solid gray">
        <fo:block text-align="left" font-weight="bold">
          <xsl:value-of select="eta_avance"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell display-align="center" border="0.1pt solid gray">
        <fo:block text-align="left" font-weight="bold">
          <xsl:value-of select="nbr_ech_eta_avance"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell display-align="center" border="0.1pt solid black" border-top-width="0.5px" border-style="solid">
        <fo:block text-align="center" font-weight="bold">
      ...
      <fo:table-cell display-align="center" border="0.1pt solid black" border-top-width="0.5px" border-style="solid">
        <fo:block text-align="center" font-weight="bold">
          <xsl:value-of select="date_decision"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell display-align="center" border="0.1pt solid black" border-top-width="0.5px" border-style="solid">
        <fo:block text-align="right" wrap-option="no-wrap" font-weight="bold">
          <xsl:value-of select="montant_octr"/>
        </fo:block>
      </fo:table-cell>
    ...
    <xsl:choose>
      <xsl:when test="membre_gs=&quot;OUI&quot;">
        <fo:table-row>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="right" wrap-option="no-wrap" font-style="italic">
              <xsl:value-of select="montant_octr"/>
            </fo:block>
          </fo:table-cell>
