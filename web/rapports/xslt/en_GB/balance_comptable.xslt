      ...
      <fo:table-header>
        <fo:table-row font-weight="bold">
          ...
          <fo:table-cell number-columns-spanned="2">
            <fo:block text-align="center">Beginning balance</fo:block>
          </fo:table-cell>
          <fo:table-cell number-columns-spanned="2">
            <fo:block text-align="center">Transactions</fo:block>
          </fo:table-cell>
          <fo:table-cell number-columns-spanned="2">
            <fo:block text-align="center">        Total période       </fo:block>
          </fo:table-cell>
          <fo:table-cell number-columns-spanned="2">
            <fo:block text-align="center">End balance</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block>Variation in borrowing rate </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row font-weight="bold">
          ...
          <fo:table-cell border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
            <fo:block text-align="right" space-before.optimum="0.2cm">Debit</fo:block>
          </fo:table-cell>
          <fo:table-cell border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
            <fo:block text-align="right" space-before.optimum="0.2cm">Credit</fo:block>
          </fo:table-cell>
          <fo:table-cell border-bottom-width="0.5pt" border-bottom-style="solid" border-bottom-color="black">
            <fo:block text-align="right" space-before.optimum="0.2cm">Debit</fo:block>
          </fo:table-cell>
      ...
      <fo:table-row font-weight="bold">
        ...
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black">
          <fo:block text-align="right" space-before.optimum="0.2cm">
            <xsl:value-of select="solde_debut_deb"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black">
          <fo:block text-align="right" space-before.optimum="0.2cm">
            <xsl:value-of select="solde_debut_cre"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black">
          <fo:block text-align="right" space-before.optimum="0.2cm">
        ...
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black">
          <fo:block text-align="right" space-before.optimum="0.2cm">
            <xsl:value-of select="calcul_debit"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black">
          <fo:block text-align="right" space-before.optimum="0.2cm">
            <xsl:value-of select="calcul_credit"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black">
          <fo:block text-align="right" space-before.optimum="0.2cm">
            <xsl:value-of select="solde_fin_deb"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black">
          <fo:block text-align="right" space-before.optimum="0.2cm">
            <xsl:value-of select="solde_fin_cre"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell border-top-width="0.5pt" border-top-style="solid" border-top-color="black">
          <fo:block text-align="left" space-before.optimum="0.2cm">
