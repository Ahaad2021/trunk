...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
        ...
        <fo:table border-collapse="collapse" border-separation.inline-progression-direction="10pt" width="100%" table-layout="fixed">
          ...
          <fo:table-header>
            <fo:table-row font-weight="bold">
              ...
              <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="right">Account balance</fo:block>
              </fo:table-cell>
              <fo:table-cell display-align="center" border="0.1pt solid gray">
              ...
              <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center">Interest rate (%)</fo:block>
              </fo:table-cell>
              <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center">Already extended?</fo:block>
              </fo:table-cell>
              <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center">Client decision</fo:block>
              </fo:table-cell>
            </fo:table-row>
          </fo:table-header>
  ...
  <xsl:template match="total_general">
    <fo:table-body>
      <fo:table-row font-weight="bold" font-style="italic" border-collapse="separate" border-separation.block-progression-direction="25pt">
        <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="2">
          <fo:block text-align="center">General total </fo:block>
        </fo:table-cell>
        <fo:table-cell display-align="center" border="0.1pt solid gray">
