		...
		<fo:table border-collapse="collapse" width="100%" table-layout="fixed">
			...
			<fo:table-header>
				...
				<fo:table-row font-weight="bold">
					...
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">Movements in external agencies</fo:block>
					</fo:table-cell>
				</fo:table-row>
		...
		<fo:table border-collapse="collapse" width="44%" table-layout="fixed">
			...
			<fo:table-header>
				...
				<fo:table-row font-weight="bold">
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">
							Agency <xsl:value-of select="agence" />
						</fo:block>
					</fo:table-cell>
			...
			<fo:table-body>	
				<fo:table-row>				
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">Total deposits in external agencies</fo:block>
					</fo:table-cell>
				...
				<fo:table-row>				
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">Total withdrawals in external agencies</fo:block>
					</fo:table-cell>
