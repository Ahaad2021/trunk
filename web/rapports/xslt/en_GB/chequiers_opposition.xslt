...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="infos_synthetique">
		...
		<fo:table border-collapse="separate" border-separation.inline-progression-direction="10pt" width="35%" table-layout="fixed">
			...
			<fo:table-body>
				<fo:table-row>
					<fo:table-cell>
						<fo:block text-align="left">Total number of checkbooks with stop payment</fo:block>
					</fo:table-cell>
					<fo:table-cell>
				...
				<fo:table-row>
					<fo:table-cell>
						<fo:block text-align="left">Total number of checks with stop payment</fo:block>
					</fo:table-cell>
					<fo:table-cell>
	...
	<xsl:template match="chequiers_opposition_data">
		...
		<xsl:call-template name="titre_niv1">
			<xsl:with-param name="titre">Checkbook Details</xsl:with-param>
		</xsl:call-template>
		...
		<fo:table border-collapse="collapse" width="100%" table-layout="fixed">
			...
			<fo:table-header>
				...
				<fo:table-row font-weight="bold">
					...
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">Stop payment date</fo:block>
					</fo:table-cell>
					<fo:table-cell display-align="center" border="0.1pt solid gray">
	...
	<xsl:template match="cheques_opposition_data">
		...
		<xsl:call-template name="titre_niv1">
			<xsl:with-param name="titre">Check Details</xsl:with-param>
		</xsl:call-template>
		...
		<fo:table border-collapse="collapse" width="100%" table-layout="fixed">
			...
			<fo:table-header>
				...
				<fo:table-row font-weight="bold">
					...
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">Check N°</fo:block>
					</fo:table-cell>
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">Check Status</fo:block>
					</fo:table-cell>
					<fo:table-cell display-align="center" border="0.1pt solid gray">
						<fo:block text-align="center">Description</fo:block>
					</fo:table-cell>
