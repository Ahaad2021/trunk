...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  ...
  <xsl:template match="infos_globales">
    <xsl:call-template name="titre_niv1">
      <xsl:with-param name="titre" select="concat('Global informations ', ../@devise)"/>
    </xsl:call-template>
      ...
      <fo:table-body>
        <xsl:choose>
          <xsl:when test="sans_gui=1">
            <fo:table-row>
              <fo:table-cell>
                <fo:block>Agent without cash register : </fo:block>
              </fo:table-cell>
              <fo:table-cell>
                <fo:block>
          ...
          <xsl:otherwise>
            ...
            <fo:table-row>
              <fo:table-cell>
                <fo:block>Cash at the beginning of the day : </fo:block>
              </fo:table-cell>
              <fo:table-cell>
                <fo:block>
            ...
            <fo:table-row>
              <fo:table-cell>
                <fo:block>Cash at the end of day : </fo:block>
              </fo:table-cell>
              <fo:table-cell>
                <fo:block>
    ...
    <fo:table border="none" border-collapse="separate" border-separation.inline-progression-direction="10pt" width="100%" table-layout="fixed">
      ...
      <fo:table-header>
        <fo:table-row font-weight="bold">
          <fo:table-cell>
            <fo:block space-before.optimum="0.5cm" space-after.optimum="0.2cm">Operation</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block space-before.optimum="0.5cm" space-after.optimum="0.2cm" text-align="right">Number</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block space-before.optimum="0.5cm" space-after.optimum="0.2cm" text-align="right">Amount</fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-header>
      <fo:table-body>
  ...
  <xsl:template match="ligne_resume_transactions">
    ...
    <xsl:if test="@total = '1'">
      <fo:table-row font-weight="bold">
        ...
        <fo:table-cell>
          <fo:block space-before.optimum="0.2cm" text-align="right">
            <xsl:value-of select="nombre"/>
          </fo:block>
        </fo:table-cell>
        <fo:table-cell>
  ...
  <xsl:template match="detail">
    <xsl:call-template name="titre_niv1">
      <xsl:with-param name="titre" select="concat('Transactions detail ', ../@devise)"/>
    </xsl:call-template>
    <fo:table border="none" border-collapse="separate" width="100%" table-layout="fixed">
      ...
      <fo:table-header>
        <fo:table-row font-weight="bold">
          <fo:table-cell>
            <fo:block space-after.optimum="0.1cm">Trans nbr</fo:block>
          </fo:table-cell>
          <fo:table-cell>
          ...
          <fo:table-cell>
            <fo:block space-after.optimum="0.1cm">Operation</fo:block>
          </fo:table-cell>
          <fo:table-cell padding-end="0.2cm">
            <fo:block space-after.optimum="0.1cm" text-align="right">Debit acct</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block space-after.optimum="0.1cm">Credit acct</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block space-after.optimum="0.1cm" text-align="right">Debit amt</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block space-after.optimum="0.1cm" text-align="right">Credit amt</fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-header>
      <fo:table-body>
  ...
  <xsl:template match="ligne_detail">
    <fo:table-row>
      ...
      <fo:table-cell padding-end="0.2cm">
        <fo:block text-align="right">
          <xsl:value-of select="compte_debit"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell>
        <fo:block>
          <xsl:value-of select="compte_credit"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell>
        <fo:block text-align="right">
