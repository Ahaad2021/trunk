  ...
  <xsl:template match="clients">
    ...
    <fo:table border-collapse="collapse" border-separation.inline-progression-direction="10pt" width="100%" table-layout="fixed">
      ...
      <fo:table-header>
        <fo:table-row>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">Operation date</fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">Client No.</fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">Name and First Name</fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">Gross interest received by the client</fo:block>
          </fo:table-cell>
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:block text-align="center">Tax collected</fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-header>
      <fo:table-body>
      ...
      <fo:table-body>
        ...
        <fo:table-row font-weight="bold">
          <fo:table-cell display-align="center" border="0.2pt solid black" number-columns-spanned="3">
            <fo:block font-weight="bold" text-align="center"> Grand total</fo:block>
          </fo:table-cell>
  ...
  <xsl:template match="header_contextuel">
    ...
    <fo:list-block>
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block><xsl:value-of select="$point_liste" disable-output-escaping="yes"/>Start date : <xsl:value-of select="date_debut"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
    </fo:list-block>
    <fo:list-block>
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block><xsl:value-of select="$point_liste" disable-output-escaping="yes"/>End date : <xsl:value-of select="date_fin"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
    </fo:list-block>
    <fo:list-block>
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block><xsl:value-of select="$point_liste" disable-output-escaping="yes"/>Savings product : <xsl:value-of select="produit_epargne"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
    </fo:list-block>
  </xsl:template>
  ...
  <xsl:template match="sous_total">
    <fo:table-row font-weight="bold">
      <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="3">
        <fo:block font-weight="bold" text-align="center"> Sub total</fo:block>
      </fo:table-cell>
      <fo:table-cell display-align="center" border="0.1pt solid gray">
        <fo:block font-weight="bold" text-align="right">
