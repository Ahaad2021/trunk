      ...
      <fo:flow flow-name="xsl-region-body">
        <fo:table border="none" border-collapse="separate" border-separation.inline-progression-direction="10pt">
          ...
          <fo:table-header border-separation.block-progression-direction="5pt">
            ...
            <fo:table-row font-weight="bold">
              <fo:table-cell>
                <fo:block>Type of account</fo:block>
              </fo:table-cell>
              <fo:table-cell>
              ...
              <fo:table-cell>
                <fo:block text-align="right">average</fo:block>
              </fo:table-cell>
            </fo:table-row>
          </fo:table-header>
          <fo:table-body>
        ...
        <xsl:when test="@libel='Total'">
          ...
          <fo:table-cell padding-before="8pt">
            <fo:block text-align="right">
              <xsl:value-of select="comptes/@nombre"/>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell padding-before="8pt">
            <fo:block text-align="right">
              <xsl:value-of select="comptes/@prc"/>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell padding-before="8pt">
            <fo:block text-align="right">
              <xsl:value-of select="solde/@montant"/>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell padding-before="8pt">
            <fo:block text-align="right">
              <xsl:value-of select="solde/@prc"/>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell padding-before="8pt">
            <fo:block text-align="right">
              <xsl:value-of select="solde_moyen"/>
            </fo:block>
          </fo:table-cell>
        </xsl:when>
        <xsl:otherwise>
