        ...
        <fo:table width="100%" table-layout="fixed">
          ...
          <fo:table-header>
            <fo:table-row font-weight="bold" border-width="0.3mm" border-style="solid">
              ...
              <fo:table-cell border-width="0.3mm" border-style="solid">
                <fo:block text-align="center">closing date</fo:block>
              </fo:table-cell>
              <fo:table-cell border-width="0.3mm" border-style="solid">
                <fo:block text-align="center">Reason</fo:block>
              </fo:table-cell>
              <fo:table-cell border-width="0.3mm" border-style="solid">
    ...
    <fo:table-row>
      ...
      <fo:table-cell border-width="0.1mm" border-style="solid">
        <fo:block text-align="right">
          <xsl:value-of select="solde_clot"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell border-width="0.1mm" border-style="solid">
        <fo:block text-align="right">
          <xsl:value-of select="solde_clot_cv"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell border-width="0.1mm" border-style="solid">
        <fo:block text-align="center">
          <xsl:value-of select="date_clot"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell border-width="0.1mm" border-style="solid">
        <fo:block text-align="left">
          <xsl:value-of select="raison_clot"/>
        </fo:block>
      </fo:table-cell>
      <fo:table-cell border-width="0.1mm" border-style="solid">
        <fo:block text-align="left">
      ...
      <fo:table-cell border-width="0.1mm" border-style="solid">
        <fo:block text-align="left">
          <xsl:value-of select="classe_comptable"/>
        </fo:block>
      </fo:table-cell>
    </fo:table-row>
  </xsl:template>
    ...
    <fo:table border-collapse="separate" width="50%" table-layout="fixed">
      ...
      <fo:table-body>
        <fo:table-row font-weight="bold">
          ...
          <fo:table-cell>
            <fo:block text-align="right">
              <xsl:value-of select="total_nombre"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row font-weight="bold">
