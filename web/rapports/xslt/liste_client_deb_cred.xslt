	...
	<fo:table-row>
		<xsl:choose>
			<xsl:when test="groupe_gs='groupe'">
				...
				<fo:table-cell border-width="0.2mm" border-style="solid">
					<fo:block font-weight="bold" text-align="right"><xsl:value-of select="num_cpte"/></fo:block>
				</fo:table-cell>
				<fo:table-cell border-width="0.2mm" border-style="solid">
			...
			<xsl:when test="membre_gs='membre'">
				<fo:table-cell border-width="0.02mm" border-style="solid" text-align="right">
					<fo:block font-style="italic" font-weight="500"><xsl:value-of select="index"/></fo:block>
				</fo:table-cell>
				<fo:table-cell border-width="0.02mm" border-style="solid" text-align="right">
					<fo:block font-style="italic" font-weight="500"><xsl:value-of select="id_client"/></fo:block>
				</fo:table-cell>
				<fo:table-cell border-width="0.02mm" border-style="solid" text-align="center">
					<fo:block font-style="italic" font-weight="500"><xsl:value-of select="id_doss"/></fo:block>
				</fo:table-cell>
				<fo:table-cell border-width="0.02mm" border-style="solid">
					<fo:block font-style="italic" font-weight="500"><xsl:value-of select="nom"/></fo:block>
				</fo:table-cell>
				<fo:table-cell border-width="0.02mm" border-style="solid">
					<fo:block font-style="italic" font-weight="500" text-align="right"><xsl:value-of select="num_cpte"/></fo:block>
				</fo:table-cell>
				<fo:table-cell border-width="0.02mm" border-style="solid">
					<fo:block font-style="italic" font-weight="500" text-align="right"><xsl:value-of select="encours_client"/></fo:block>
				</fo:table-cell>
			</xsl:when>
			<xsl:otherwise>
				...
				<fo:table-cell border-width="0.1mm" border-style="solid">
					<fo:block text-align="right"><xsl:value-of select="num_cpte"/></fo:block>
				</fo:table-cell>
				<fo:table-cell border-width="0.1mm" border-style="solid">
