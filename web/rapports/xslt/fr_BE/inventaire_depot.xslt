...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
                  ...
                  <!--  <fo:table-column column-width="proportional-column-width(2)"/>
                    ...
                    <fo:table-header>
                        <fo:table-row>
                            ...
                            <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                                <fo:block text-align="center">solde début période</fo:block>
                            </fo:table-cell>
                            <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                                <fo:block text-align="center">Total mvts. dépôts</fo:block>
                            </fo:table-cell>
                            <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                                <fo:block text-align="center">Total mvts. retrait</fo:block>
                            </fo:table-cell>
                            <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                                <fo:block text-align="center">Solde fin période</fo:block>
                            </fo:table-cell>
                            <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                                <fo:block text-align="center">Date de naissance</fo:block>
                            </fo:table-cell>
                            <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                                <fo:block text-align="center">Etat Civile</fo:block>
                            </fo:table-cell>
                            <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
    ...
    <xsl:template match="ligne_produit">
        <fo:table-row>
            ...
            <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center" font-size="9pt"><xsl:value-of select="num_cpte"/></fo:block>
            </fo:table-cell>
            <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center" font-size="9pt">    <xsl:value-of select="nom_client"/></fo:block>
            </fo:table-cell>
            <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center" font-size="9pt"><xsl:value-of select="sexe"/></fo:block>
            </fo:table-cell>
            <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center" font-size="9pt"><xsl:value-of select="solde_debut_periode"/></fo:block>
            </fo:table-cell>
            <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center" font-size="9pt">    <xsl:value-of select="total_mouvement_depot"/></fo:block>
            </fo:table-cell>
            <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center" font-size="9pt"><xsl:value-of select="total_mouvement_retrait"/></fo:block>
            </fo:table-cell>
            <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center" font-size="9pt"><xsl:value-of select="solde_fin_periode"/></fo:block>
            </fo:table-cell>
            <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center" font-size="9pt">    <xsl:value-of select="date_naissance"/></fo:block>
            </fo:table-cell>
            <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center" font-size="9pt"><xsl:value-of select="etat_civile"/></fo:block>
            </fo:table-cell>
            <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center" font-size="9pt"><xsl:value-of select="sector"/></fo:block>
            </fo:table-cell>
            <!--<fo:table-cell display-align="center" border="0.1pt solid gray">
            ...
            <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center" font-size="9pt"><xsl:value-of select="tel"/></fo:block>
            </fo:table-cell>
            <fo:table-cell display-align="center" border="0.1pt solid gray">
                <fo:block text-align="center" font-size="9pt">    <xsl:value-of select="idnumber"/></fo:block>
            </fo:table-cell>
    ...
    <xsl:template match="totals">
        <fo:table-row font-weight="bold">
            <fo:table-cell display-align="center" border="0.1pt solid black"  number-columns-spanned="4">
