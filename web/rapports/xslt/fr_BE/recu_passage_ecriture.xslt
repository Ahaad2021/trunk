  ...
  <xsl:template match="infos_synthetiques">
    ...
    <fo:list-block>
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block><xsl:value-of select="$point_liste" disable-output-escaping="yes"/>Opérateur: <xsl:value-of select="login"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
      ...
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block><xsl:value-of select="$point_liste" disable-output-escaping="yes"/>Libellé écriture: <xsl:value-of select="libelle"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
      ...
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block><xsl:value-of select="$point_liste" disable-output-escaping="yes"/>Login initiateur : <xsl:value-of select="login_initiateur"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
    </fo:list-block>
  </xsl:template>
