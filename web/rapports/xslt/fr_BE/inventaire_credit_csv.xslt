                ...
                <fo:table-header>
                    <fo:table-row>
                        <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                            <fo:block text-align="center">Numero Client</fo:block>
                        </fo:table-cell>
                        <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                            <fo:block text-align="center">Numéro dossier</fo:block>
                        </fo:table-cell>
                        <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                            <fo:block text-align="center">Nom client</fo:block>
                        </fo:table-cell>
                        <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                            <fo:block text-align="center">Capital début période</fo:block>
                        </fo:table-cell>
                        <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                            <fo:block text-align="center">Capital déboursé au cours de la période</fo:block>
                        </fo:table-cell>
                        <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                            <fo:block text-align="center">Capital remboursé au cours de la période</fo:block>
                        </fo:table-cell>
                        <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                            <fo:block text-align="center">Intérêts ordinaires remboursés au cours de la période</fo:block>
                        </fo:table-cell>
                        <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                            <fo:block text-align="center">Intérêts de retard remboursés au cours de la période</fo:block>
                        </fo:table-cell>
                        <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                            <fo:block text-align="center">Montant total remboursé au cours de la période</fo:block>
                        </fo:table-cell>
                        <xsl:if test="etat_radie = 'false'">
                            <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                                <fo:block text-align="center">Capital restant dû à la fin de période</fo:block>
                            </fo:table-cell>
                        </xsl:if>
                        <xsl:if test="etat_radie = 'true'">
                            <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
                                <fo:block text-align="center">Capital Passé en Perte</fo:block>
                            </fo:table-cell>
                        </xsl:if>
                        <xsl:if test="etat_tous = 'true'">
                            <fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="1">
