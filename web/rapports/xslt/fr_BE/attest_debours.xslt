  ...
  <xsl:template match="body">
    <fo:list-block>
      ...
      <fo:list-item>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.3cm">Numéro de dossier: <xsl:value-of select="id_doss"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
      <fo:list-item>
        <fo:list-item-label>
        ...
        <fo:list-item-body>
          <fo:block space-before.optimum="0.3cm">Numéro de chèque: <xsl:value-of select="num_cheque"/></fo:block>
        </fo:list-item-body>
      </fo:list-item>
    </fo:list-block>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:list-block>
              <fo:list-item>
                ...
                <fo:list-item-body>
                  <fo:block space-before.optimum="0.3cm">Montant déboursé: <xsl:value-of select="mnt_debours"/></fo:block>
                </fo:list-item-body>
              </fo:list-item>
              <fo:list-item>
                <fo:list-item-label>
                ...
                <fo:list-item-body>
                  <fo:block space-before.optimum="0.3cm">Montant de la commission: <xsl:value-of select="mnt_com"/></fo:block>
                </fo:list-item-body>
              </fo:list-item>
              <fo:list-item>
                <fo:list-item-label>
              ...
              <fo:list-item>
                ...
                <fo:list-item-body>
                  <fo:block space-before.optimum="0.3cm">Montant des assurances: <xsl:value-of select="mnt_ass"/></fo:block>
                </fo:list-item-body>
              </fo:list-item>
              <fo:list-item>
                <fo:list-item-label>
                ...
                <fo:list-item-body>
                  <fo:block space-before.optimum="0.3cm">Montant des frais de dossier: <xsl:value-of select="mnt_frais"/></fo:block>
                </fo:list-item-body>
              </fo:list-item>
              <fo:list-item>
                <fo:list-item-label>
          ...
          <fo:table-cell display-align="center" border="0.1pt solid gray">
            <fo:list-block>
              ...
              <fo:list-item>
                ...
                <fo:list-item-body>
                  <fo:block space-before.optimum="0.3cm">Garantie numéraire mobilisée: <xsl:value-of select="gar_num_mob"/></fo:block>
                </fo:list-item-body>
              </fo:list-item>
              <fo:list-item>
                <fo:list-item-label>
                ...
                <fo:list-item-body>
                  <fo:block space-before.optimum="0.3cm">Garantie matérielle mobilisée: <xsl:value-of select="gar_mat_mob"/></fo:block>
                </fo:list-item-body>
              </fo:list-item>
              <fo:list-item>
                <fo:list-item-label>
