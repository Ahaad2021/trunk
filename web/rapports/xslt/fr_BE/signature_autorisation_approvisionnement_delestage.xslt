        ...
        <fo:table width="100%" table-layout="fixed">
            ...
            <fo:table-body>
                <fo:table-row>
                    ...
                    <fo:table-cell>
                        <fo:block text-align="center"><fo:inline font-size="14pt"><xsl:value-of select="$crayon" disable-output-escaping="yes"/></fo:inline> Nom et signature pour approbation</fo:block>
                    </fo:table-cell>
                </fo:table-row>
            </fo:table-body>
        </fo:table>
