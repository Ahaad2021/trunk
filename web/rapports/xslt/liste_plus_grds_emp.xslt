...
<xsl:template match="details">
	<xsl:call-template name="titre_niv1"><xsl:with-param name="titre" select="'Details of List of 10 Biggest Borrowers'"/></xsl:call-template>
		...
		<xsl:choose>
			<xsl:when test="groupe_gs='groupe'">
				...
				<fo:table-cell border-width="0.1mm" border-style="solid" text-align="center">
					<fo:block text-align="left"><xsl:value-of select="nom"/></fo:block>
				</fo:table-cell>
				<fo:table-cell border-width="0.1mm" border-style="solid">
					<fo:block text-align="center"><xsl:value-of select="date_pret"/></fo:block>
				</fo:table-cell>
				<fo:table-cell border-width="0.1mm" border-style="solid">
					<fo:block text-align="right"><xsl:value-of select="mnt_pret"/></fo:block>
				</fo:table-cell>
				<fo:table-cell border-width="0.1mm" border-style="solid">
					<fo:block text-align="center"><xsl:value-of select="echeances"/></fo:block>
				</fo:table-cell>
				<fo:table-cell border-width="0.1mm" border-style="solid" text-align="center">
					<fo:block text-align="right"><xsl:value-of select="solde"/></fo:block>
				</fo:table-cell>
				<fo:table-cell border-width="0.1mm" border-style="solid">
					<fo:block text-align="right"><xsl:value-of select="mnt_retard"/></fo:block>
				</fo:table-cell>
				<fo:table-cell border-width="0.1mm" border-style="solid">
					<fo:block text-align="right"><xsl:value-of select="garanties"/></fo:block>
				</fo:table-cell>
				<fo:table-cell border-width="0.1mm" border-style="solid">
					<fo:block text-align="right"><xsl:value-of select="mnt_prov"/></fo:block>
				</fo:table-cell>
			</xsl:when>
...
<xsl:template match="total">
		<fo:table-row>
			...
			<fo:table-cell background-color="#CCFFFF" border-width="0.2mm" border-style="solid" text-align="right">
				<fo:block font-weight="bold" text-align="right"><xsl:value-of select="tot_mnt_pret"/></fo:block>
			</fo:table-cell>
			...
			<fo:table-cell background-color="#CCFFFF" border-width="0.2mm" border-style="solid" text-align="right">
				<fo:block font-weight="bold" text-align="right"><xsl:value-of select="tot_solde"/></fo:block>
			</fo:table-cell>

			<fo:table-cell background-color="#CCFFFF" border-width="0.2mm" border-style="solid" text-align="right">
				<fo:block font-weight="bold"><xsl:value-of select="tot_mnt_retard"/> </fo:block>
			</fo:table-cell>
			<fo:table-cell background-color="#C4C2C1" border-width="0.2mm" border-style="solid" text-align="right">
				<fo:block font-weight="bold" text-align="right"></fo:block>
			</fo:table-cell>
			<fo:table-cell background-color="#CCFFFF" border-width="0.2mm" border-style="solid" text-align="right">
				<fo:block font-weight="bold" text-align="right"><xsl:value-of select="tot_mnt_prov"/> </fo:block>
			</fo:table-cell>
		</fo:table-row>
