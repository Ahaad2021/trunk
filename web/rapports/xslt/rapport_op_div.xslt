    ...
    <fo:page-sequence master-reference="main" font-size="8pt" font-family="Helvetica">
      ...
      <fo:flow flow-name="xsl-region-body">
        ...
        <fo:table-row font-weight="bold">
          <fo:table-cell>
            <fo:block text-align="center">Num transaction</fo:block>
          </fo:table-cell>
          <fo:table-cell>
          ...
          <fo:table-cell>
            <fo:block text-align="center">Libellé opération</fo:block>
          </fo:table-cell>
          <fo:table-cell>
            <fo:block text-align="center">No Client</fo:block>
          </fo:table-cell>
          <fo:table-cell>
     ...
     <fo:table-cell padding-before="8pt">
      ...
      <fo:table-cell padding-before="8pt">
        <fo:block font-weight="bold" text-align="center"> Total période :</fo:block>
      </fo:table-cell>
      <fo:table-cell padding-before="8pt">
