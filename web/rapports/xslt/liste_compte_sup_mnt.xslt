	  ...
	  <fo:table-column column-width="proportional-column-width(2)"/> 
		...
		<fo:table-header>
	      ...
	      <fo:table-cell display-align="center" border="0.1pt solid gray">
					<fo:block text-align="center">Rang</fo:block>
				</fo:table-cell>
				<fo:table-cell display-align="center" border="0.1pt solid gray">
...
<xsl:template match="details">
	<fo:table-row>
	  <fo:table-cell display-align="center" border="0.1pt solid gray">
		...
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block text-align="center"><xsl:value-of select="idclient"/></fo:block>
		</fo:table-cell>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block text-align="center"><xsl:value-of select="nom"/></fo:block>
		</fo:table-cell>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block  text-align="center"><xsl:value-of select="numcpt"/></fo:block>
		</fo:table-cell>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
			<fo:block  text-align="center"><xsl:value-of select="libel"/></fo:block>
		</fo:table-cell>
		<fo:table-cell display-align="center" border="0.1pt solid gray">
...
<xsl:template match="total">
	<fo:table-row>
		...
		<fo:table-cell display-align="center" border="0.1pt solid gray" number-columns-spanned="5">
			<fo:block text-align="right" font-weight="bold" wrap-option="no-wrap" ><xsl:value-of select="total_solde"/></fo:block>
		</fo:table-cell>
	</fo:table-row>	
</xsl:template>
</xsl:stylesheet>
