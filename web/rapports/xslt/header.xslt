...
<xsl:template name="header_body">
		<fo:table width="100%" table-layout="fixed">
			...
			<fo:table-body>
				...
				<fo:table-row>
						<fo:table-cell display-align="left">
							<fo:block text-align="left">Opérateur: <xsl:value-of select="utilisateur"/></fo:block>
						</fo:table-cell>
						<fo:table-cell display-align="right">
		...
		<fo:block background-color="silver" text-align="center" font-size="11pt" font-weight="bold"><xsl:value-of select="titre"/></fo:block>
</xsl:template>
