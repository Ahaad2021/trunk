...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  ...
  <xsl:template match="body">
    <fo:list-block>
      ...
      <xsl:if test="nom_agence_remote">
        <fo:list-item>
          <fo:list-item-label>
            <fo:block/>
          </fo:list-item-label>
          <fo:list-item-body>
            <fo:block space-before.optimum="0.3cm">Nom de l'Agence en déplacé : <xsl:value-of select="nom_agence_remote"/></fo:block>
          </fo:list-item-body>
        </fo:list-item>
      </xsl:if>
      ...
      <xsl:if test="/recu/@type='6' or /recu/@type='8' or /recu/@type='40'">
        ...
        <xsl:if test="frais_attente">
          ...
          <xsl:if test="commission_od_deplace">
              <fo:list-item>
                  <fo:list-item-label>
                      <fo:block/>
                  </fo:list-item-label>
                  <fo:list-item-body>
                      <fo:block space-before.optimum="0.3cm">Commission sur opération en déplacé : <xsl:value-of select="commission_od_deplace"/></fo:block>
                  </fo:list-item-body>
              </fo:list-item>
          </xsl:if>
        <xsl:if test="solde">
   ...
   <xsl:if test="hasBilletage">
   	    <fo:list-item>
	            ...
	            <fo:list-item-body><fo:block space-before.optimum="0.1cm">Billetage : </fo:block></fo:list-item-body>
	    </fo:list-item>
	...
	<fo:table width="100%" border-collapse="collapse"
		...
		<fo:table-body>
			<fo:table-row>
                ...
                <xsl:if test="libel_billet_0 !=''">
                    <fo:table-cell border-width="1pt" border-color="black" border-style="solid" padding="8pt">
                        <fo:block text-align="center">
