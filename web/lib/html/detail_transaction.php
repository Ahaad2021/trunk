...
if (isset($id_transaction)) {
  ...
  echo "<TD align=\"center\"><b>"._("Heure")."</b></TD><TD align=\"center\"><b>"._("Fonction")."</b></TD><TD align=\"center\"><b>"._("Login")."</b></TD><TD align=\"center\"><b>"._("N° client")."</b></TD></TR>\n";
  ...
  {
    if ($details['id_client'] > 0) { 
        echo "<TD align=\"center\">".sprintf("%06d", $details['id_client'])."</TD>\n";
    } else {
        echo "<TD></TD>\n";
    }
  }
