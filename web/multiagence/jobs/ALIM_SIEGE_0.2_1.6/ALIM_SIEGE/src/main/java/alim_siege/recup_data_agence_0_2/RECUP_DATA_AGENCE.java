...
package alim_siege.recup_data_agence_0_2;
	...
	public void tPostgresqlConnection_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbUser_tPostgresqlConnection_2 = context.DB_user;
	...
	public void tPostgresqlConnection_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbUser_tPostgresqlConnection_1 = context.app_db_login;
		...
		try {
			...
			java.io.InputStream inContext = RECUP_DATA_AGENCE.class
					.getClassLoader().getResourceAsStream(
							"alim_siege/recup_data_agence_0_2/contexts/"
...
/************************************************************************************************
 * 151644 characters generated by Talend Open Studio for Data Integration on the
 * March 28, 2018 3:38:58 PM MUT
 ************************************************************************************************/
