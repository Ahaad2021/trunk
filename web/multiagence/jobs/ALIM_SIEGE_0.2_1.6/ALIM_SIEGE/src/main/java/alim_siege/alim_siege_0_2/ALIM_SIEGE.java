...
package alim_siege.alim_siege_0_2;
...
public class ALIM_SIEGE implements TalendJob {
	...
	public void tPostgresqlCommit_3_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tPostgresqlCommit_8_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tPostgresqlCommit_3_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tPostgresqlCommit_8_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tPostgresqlConnection_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbUser_tPostgresqlConnection_1 = context.DB_user;
				...
				try {
					...
					while (rs_tPostgresqlInput_1.next()) {
						...
						if (row4 != null) {
							...
							alim_siege.recup_data_agence_0_2.RECUP_DATA_AGENCE childJob_tRunJob_2 = new alim_siege.recup_data_agence_0_2.RECUP_DATA_AGENCE();
							// pass DataSources
				...
				try {
					...
					while (rs_tPostgresqlInput_3.next()) {
						...
						if (colQtyInRs_tPostgresqlInput_3 < 1) {
							row8.error_count = null;
						} else {

							if (rs_tPostgresqlInput_3.getObject(1) != null) {
								row8.error_count = rs_tPostgresqlInput_3
										.getInt(1);
							} else {
								row8.error_count = null;
							}
						...
						{ // start of Var scope
							...
							Update_status_tmp.is_sucess = row8.error_count == 0 ? true
									: false;
						...
						if (Update_status != null) {
							...
							if (Update_status.id == null) {
								pstmt_tPostgresqlOutput_3.setNull(
							...
							if ((batchSize_tPostgresqlOutput_3 > 0)
								...
								try {
									...
									int countSum_tPostgresqlOutput_3 = 0;
									for (int countEach_tPostgresqlOutput_3 : e
											.getUpdateCounts()) {
										countSum_tPostgresqlOutput_3 += (countEach_tPostgresqlOutput_3 < 0 ? 0
												: countEach_tPostgresqlOutput_3);
									}
					...
					while (limittFileInputDelimited_1 != 0
						...
						try {
							...
							if (rowtFileInputDelimited_1.length == 1
								...
								row3.app_db_host = null;

								row3.app_db_name = null;

								row3.id_agc = null;

								row3.app_db_username = null;

								row3.app_db_password = null;
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row3.app_db_host = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row3.app_db_name = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row3.app_db_username = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row3.app_db_password = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ALIM_SIEGE.class.getClassLoader()
					.getResourceAsStream(
							"alim_siege/alim_siege_0_2/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 223268 characters generated by Talend Open Studio for Data Integration on the
 * March 28, 2018 3:39:03 PM MUT
 ************************************************************************************************/
